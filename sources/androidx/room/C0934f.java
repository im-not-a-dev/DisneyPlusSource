...
public class C0934f {
    /* renamed from: a */
    public static <T extends RoomDatabase> C0915a<T> m5137a(Context context, Class<T> cls, String str) {
        if (str != null && str.trim().length() != 0) {
            return new C0915a<>(context, cls, str);
        }
        throw new IllegalArgumentException("Cannot build a database with null or empty name. If you are trying to create an in memory database, use Room.inMemoryDatabaseBuilder");
    }

    /* renamed from: a */
    public static <T extends RoomDatabase> C0915a<T> m5136a(Context context, Class<T> cls) {
        return new C0915a<>(context, cls, null);
    }

    /* renamed from: a */
    static <T, C> T m5138a(Class<C> cls, String str) {
        String str2;
