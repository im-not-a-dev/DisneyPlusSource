...
public class AlertDialogLayout extends C0224f0 {
    public AlertDialogLayout(Context context) {
        super(context);
    }

    /* renamed from: a */
    private void m1018a(View view, int i, int i2, int i3, int i4) {
        view.layout(i, i2, i3 + i, i4 + i2);
    }

    /* renamed from: c */
    private void m1020c(int i, int i2) {
        int makeMeasureSpec = MeasureSpec.makeMeasureSpec(getMeasuredWidth(), 1073741824);
        for (int i3 = 0; i3 < i; i3++) {
            View childAt = getChildAt(i3);
            if (childAt.getVisibility() != 8) {
                C0225a aVar = (C0225a) childAt.getLayoutParams();
                if (aVar.width == -1) {
                    int i4 = aVar.height;
    ...
    /* renamed from: d */
    private boolean m1021d(int i, int i2) {
        int i3;
        int i4;
        int i5;
        int i6;
        ...
        for (int i10 = 0; i10 < childCount; i10++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (id == C3863f.topPanel) {
                    view = childAt;
                } else if (id == C3863f.buttonPanel) {
                    view2 = childAt;
                } else if ((id != C3863f.contentPanel && id != C3863f.customPanel) || view3 != null) {
                    return false;
                } else {
                    view3 = childAt;
                }
    ...
    public void onLayout(boolean r18, int r19, int r20, int r21, int r22) {
        ...
        L_0x005a:
            ...
            r15 = r2
            androidx.appcompat.widget.f0$a r15 = (androidx.appcompat.widget.C0224f0.C0225a) r15
            int r2 = r15.f1047b
            if (r2 >= 0) goto L_0x007e
            r2 = r11
        L_0x007e:
            int r3 = p096e.p121h.p135s.C4187x.m14399n(r17)
            int r2 = p096e.p121h.p135s.C4139e.m14173a(r2, r3)
            r2 = r2 & 7
            r3 = 1
    ...
    /* renamed from: c */
    private static int m1019c(View view) {
        int o = C4187x.m14400o(view);
        if (o > 0) {
            return o;
        }
        if (view instanceof ViewGroup) {
            ...
            if (viewGroup.getChildCount() == 1) {
                return m1019c(viewGroup.getChildAt(0));
            }
        }
        return 0;
    }
