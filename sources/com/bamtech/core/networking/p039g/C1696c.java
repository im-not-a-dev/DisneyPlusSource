...
public final class C1696c {
    ...
    public static final X509TrustManager m7804a(LogDispatcher logDispatcher) {
        try {
            ...
            Intrinsics.checkReturnedValueIsNotNull((Object) instance, "TrustManagerFactory.getInstance(defaultAlgorithm)");
            try {
                instance.init(null);
                TrustManager[] trustManagers = instance.getTrustManagers();
                Intrinsics.checkReturnedValueIsNotNull((Object) trustManagers, "factory.trustManagers");
    ...
    public static final void m7805a(Builder builder, X509TrustManager x509TrustManager) {
        try {
            ...
            Intrinsics.checkReturnedValueIsNotNull((Object) a, "connectionSpec");
            C14245m mVar = C14245m.f31790h;
            Intrinsics.checkReturnedValueIsNotNull((Object) mVar, "ConnectionSpec.COMPATIBLE_TLS");
            C14245m mVar2 = C14245m.f31791i;
            Intrinsics.checkReturnedValueIsNotNull((Object) mVar2, "ConnectionSpec.CLEARTEXT");
