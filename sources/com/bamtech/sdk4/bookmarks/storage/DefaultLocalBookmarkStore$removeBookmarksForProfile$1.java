...
final class DefaultLocalBookmarkStore$removeBookmarksForProfile$1 implements C11945a {
    final /* synthetic */ String $profileId;
    final /* synthetic */ DefaultLocalBookmarkStore this$0;

    DefaultLocalBookmarkStore$removeBookmarksForProfile$1(DefaultLocalBookmarkStore defaultLocalBookmarkStore, String str) {
    ...
    public final void run() {
        ...
        if (access$getDao$p != null) {
            access$getDao$p.deleteBookmarksForProfile(this.$profileId);
        }
    }
}
