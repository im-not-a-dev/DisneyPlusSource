...
public final class DrmDelegateMapper {
    private DefaultDrmSessionManager<FrameworkMediaCrypto> audioManager;
    private DrmSession<FrameworkMediaCrypto> audioSession;
    private DefaultDrmSessionManager<FrameworkMediaCrypto> videoManager;
    private DrmSession<FrameworkMediaCrypto> videoSession;

    public final void clearSession(DrmSession<FrameworkMediaCrypto> drmSession) {
    ...
    public final DefaultDrmSessionManager<FrameworkMediaCrypto> getAudioManager() {
        return this.audioManager;
    }

    public final DefaultDrmSessionManager<FrameworkMediaCrypto> getManager(DrmSession<FrameworkMediaCrypto> drmSession) {
        return drmSession.equals(this.videoSession) ? this.videoManager : this.audioManager;
    }

    public final DefaultDrmSessionManager<FrameworkMediaCrypto> getVideoManager() {
        return this.videoManager;
    }

    public final DrmSession<FrameworkMediaCrypto> getVideoSession() {
        return this.videoSession;
    }

    public final void putSession(boolean z, DrmSession<FrameworkMediaCrypto> drmSession) {
        if (z) {
    ...
    public final void setAudioManager(DefaultDrmSessionManager<FrameworkMediaCrypto> defaultDrmSessionManager) {
        this.audioManager = defaultDrmSessionManager;
    }

    public final void setVideoManager(DefaultDrmSessionManager<FrameworkMediaCrypto> defaultDrmSessionManager) {
        this.videoManager = defaultDrmSessionManager;
    }

    public final DefaultDrmSessionManager<FrameworkMediaCrypto> getManager(boolean z) {
