...
public final class ExoPlayerAdapter extends AbstractPlayerAdapter implements ExoPlayer {
    ...
    public ExoPlayerAdapter(ExoPlayer exoPlayer, Options options2, Factory factory) {
        ...
        SimpleExoPlayer o0Var = (SimpleExoPlayer) exoPlayer2;
        if (o0Var != null) {
    ...
    private final MediaSource getCachedMediaSource(CachedMediaItemPlaylist cachedMediaItemPlaylist) {
        ...
        Intrinsics.checkReturnedValueIsNotNull((Object) createMediaSource, "createMediaSource(Uri.parse(playlist.streamUri))");
        Intrinsics.checkReturnedValueIsNotNull((Object) createMediaSource, "with(mediaSourceFactory)…ist.streamUri))\n        }");
    ...
    private final HlsMediaSource getOnlineMediaSource(MediaItemPlaylist mediaItemPlaylist, UUID uuid, String str) {
        ...
        if (obj != null) {
            ...
            if (hlsSourceEventListener != null) {
                ...
                Intrinsics.checkReturnedValueIsNotNull((Object) createMediaSource, "createMediaSource(Uri.pa…ntListener)\n            }");
                Intrinsics.checkReturnedValueIsNotNull((Object) createMediaSource, "with(HlsMediaSource.Fact…)\n            }\n        }");
                return createMediaSource;
            }
    ...
    public void clean() {
        ...
        SimpleExoPlayer o0Var = (SimpleExoPlayer) exoPlayer;
        if (o0Var != null) {
                    ...
                    if (f != null) {
                        ...
                        if (str8 != null && C12833x.m40154a((CharSequence) str8, (CharSequence) "text", false, 2, (Object) null)) {
                            ...
                            if (str9 != null && C12833x.m40151a((CharSequence) str9, ':', false, 2, (Object) null)) {
                                ...
                                if (str10 != null) {
                                    Intrinsics.checkReturnedValueIsNotNull((Object) str10, str3);
    ...
    public String getVideoPlayerName() {
        ...
        Intrinsics.throwUninitializedPropertyAccessException("videoPlayerName");
        throw null;
    }
    ...
    public String getVideoPlayerVersion() {
        ...
        Intrinsics.throwUninitializedPropertyAccessException("videoPlayerVersion");
        throw null;
    }
