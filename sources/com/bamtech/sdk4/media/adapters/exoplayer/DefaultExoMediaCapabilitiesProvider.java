...
public final class DefaultExoMediaCapabilitiesProvider implements MediaCapabilitiesProvider {
    ...
    public List<SupportedCodec> getSupportedCodecs() {
        ...
        Intrinsics.checkReturnedValueIsNotNull((Object) b, "MediaCodecUtil.getDecode….VIDEO_H265, true, false)");
        if (((C9270a) C13199w.m40591g(b)) != null) {
            arrayList.add(SupportedCodec.h265);
        }
        List b2 = C9275d.m28139b("video/avc", true, false);
        Intrinsics.checkReturnedValueIsNotNull((Object) b2, "MediaCodecUtil.getDecode….VIDEO_H264, true, false)");
        ...
        if (VERSION.SDK_INT >= 24) {
            ...
            if (hdrCapabilities != null) {
                ...
                if (supportedHdrTypes2 != null && C13174k.m40380a(supportedHdrTypes2, 1)) {
                    ...
                    Intrinsics.checkReturnedValueIsNotNull((Object) b2, "MediaCodecUtil.getDecode…OLBY_VISION, true, false)");
                    for (C9270a aVar2 : b2) {
    ...
    public boolean supportsAtmos() {
        ...
        Intrinsics.checkReturnedValueIsNotNull((Object) b, "MediaCodecUtil.getDecode…AUDIO_E_AC3, true, false)");
