                ...
                if (getThumbnailWidth() == bifThumbnailSet.getThumbnailWidth()) {
                    if (getThumbnailHeight() == bifThumbnailSet.getThumbnailHeight()) {
                        if (getIntervalMilliseconds() == bifThumbnailSet.getIntervalMilliseconds()) {
                            if (!(getTotalBytes() == bifThumbnailSet.getTotalBytes()) || !Intrinsics.areEqual((Object) getPresentations(), (Object) bifThumbnailSet.getPresentations()) || !Intrinsics.areEqual((Object) getResolution(), (Object) bifThumbnailSet.getResolution())) {
                                return false;
                            }
                        }
                    }
