...
public final class DefaultPurchaseExtension implements PurchaseExtension {
    ...
    public Single<AccessStatus> redeem(ReceiptClaim receiptClaim) {
        ...
        Intrinsics.checkReturnedValueIsNotNull((Object) a, "manager.redeem(transacti…cessStatus>(transaction))");
        return a;
    }
    ...
    public Single<AccessStatus> restore(ReceiptClaim receiptClaim) {
        ...
        Intrinsics.checkReturnedValueIsNotNull((Object) a, "manager.restore(transact…cessStatus>(transaction))");
        return a;
    }
}
