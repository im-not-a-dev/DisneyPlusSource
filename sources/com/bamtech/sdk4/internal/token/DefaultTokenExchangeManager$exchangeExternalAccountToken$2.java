...
final class DefaultTokenExchangeManager$exchangeExternalAccountToken$2<T, R> implements Function<T, SingleSource<? extends R>> {
    final /* synthetic */ String $assertion;
    final /* synthetic */ ServiceTransaction $transaction;
    final /* synthetic */ DefaultTokenExchangeManager this$0;

    DefaultTokenExchangeManager$exchangeExternalAccountToken$2(DefaultTokenExchangeManager defaultTokenExchangeManager, ServiceTransaction serviceTransaction, String str) {
    ...
    public final Single<TransactionResult<AccessContext>> apply(TokenServiceConfiguration tokenServiceConfiguration) {
        ...
        TokenExchange tokenExchange = new TokenExchange(this.$assertion, subjectTokenTypes.get(SubjectTokenTypes.PARTNER), null, this.this$0.platform, 4, null);
        return defaultTokenExchangeManager.exchange(serviceTransaction, tokenExchange).mo30227d((Consumer<? super T>) new Consumer<TransactionResult<? extends AccessContext>>(this) {
            final /* synthetic */ DefaultTokenExchangeManager$exchangeExternalAccountToken$2 this$0;
            ...
            public final void accept(TransactionResult<AccessContext> transactionResult) {
                ...
                DefaultTokenExchangeManager$exchangeExternalAccountToken$2 defaultTokenExchangeManager$exchangeExternalAccountToken$2 = this.this$0;
                DefaultImpls.d$default(defaultTokenExchangeManager$exchangeExternalAccountToken$2.$transaction, defaultTokenExchangeManager$exchangeExternalAccountToken$2.this$0, "ExternalAccountTokenExchangeSuccess", false, 4, null);
            }
            ...
            public final void accept(Throwable th) {
                DefaultTokenExchangeManager$exchangeExternalAccountToken$2 defaultTokenExchangeManager$exchangeExternalAccountToken$2 = this.this$0;
                DefaultImpls.d$default(defaultTokenExchangeManager$exchangeExternalAccountToken$2.$transaction, defaultTokenExchangeManager$exchangeExternalAccountToken$2.this$0, "ExternalAccountTokenExchangeFailure", th.getMessage(), false, 8, null);
            }
        });
    }
}
