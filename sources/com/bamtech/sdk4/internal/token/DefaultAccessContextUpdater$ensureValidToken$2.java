...
final class DefaultAccessContextUpdater$ensureValidToken$2<T, R> implements Function<T, R> {
    public static final DefaultAccessContextUpdater$ensureValidToken$2 INSTANCE = new DefaultAccessContextUpdater$ensureValidToken$2();

    DefaultAccessContextUpdater$ensureValidToken$2() {
    }
