...
final class DefaultTokenExchangeManager$exchangeAccountToken$1 extends C12881k implements Function1<Services, TokenServiceConfiguration> {
    public static final DefaultTokenExchangeManager$exchangeAccountToken$1 INSTANCE = new DefaultTokenExchangeManager$exchangeAccountToken$1();

    DefaultTokenExchangeManager$exchangeAccountToken$1() {
        super(1);
    }
