...
/* renamed from: com.bamtech.sdk4.internal.token.DefaultTokenClient$exchange$2$2$$special$$inlined$responseTransformer$1 */
/* compiled from: ResponseHandlers.kt */
public final class C2089x793fbcd3 extends C12881k implements Function1<Response, com.bamtech.core.networking.Response<? extends TokenExchangeResponse>> {
    final /* synthetic */ ResponseHandler[] $responseHandlers;
    final /* synthetic */ ServiceTransaction $transaction;

    public C2089x793fbcd3(ResponseHandler[] responseHandlerArr, ServiceTransaction serviceTransaction) {
        this.$responseHandlers = responseHandlerArr;
        this.$transaction = serviceTransaction;
        super(1);
    }

    public final com.bamtech.core.networking.Response<TokenExchangeResponse> invoke(Response response) {
