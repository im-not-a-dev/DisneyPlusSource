...
public final class BamHttpDataSourceFactory implements C9162h {
    ...
    public DataSource createDataSource(int i) {
        ...
        if (i != 4) {
            ...
            Intrinsics.checkReturnedValueIsNotNull((Object) a, "segmentDataSourceFactory.createDataSource()");
            return a;
        }
        HttpDataSource a2 = this.manifestDataSourceFactory.mo24448a();
        Intrinsics.checkReturnedValueIsNotNull((Object) a2, "manifestDataSourceFactory.createDataSource()");
        return a2;
    }
}
