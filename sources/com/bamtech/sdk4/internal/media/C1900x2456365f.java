...
/* renamed from: com.bamtech.sdk4.internal.media.DefaultOnlineMediaClient$getBifThumbnails$1$2$$special$$inlined$toMaybe$4 */
/* compiled from: ServiceRequestExtensions.kt */
public final class C1900x2456365f<T, R> implements Function<T, MaybeSource<? extends R>> {
    final /* synthetic */ String $dustEvent;
    final /* synthetic */ ServiceTransaction $transaction;

    public C1900x2456365f(ServiceTransaction serviceTransaction, String str) {
        this.$transaction = serviceTransaction;
        this.$dustEvent = str;
    }

    public final Maybe<ThumbnailManifest> apply(Response<? extends ThumbnailManifest> response) {
