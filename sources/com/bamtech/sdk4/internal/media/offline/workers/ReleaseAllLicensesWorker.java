...
public final class ReleaseAllLicensesWorker extends Worker {
    ...
    public Result doWork() {
        ...
        try {
            ...
            if (b3 != null) {
                C12880j.m40222a((Object) b3, "inputData.getStringArray…icense was not provided\")");
                b = getInputData().mo5587b("AUDIO_LICENSES");
                if (b != null) {
                    C12880j.m40222a((Object) b, "inputData.getStringArray… array was not provided\")");
                    ...
                    while (i2 < length) {
                        ...
                        if (widevineLicenseManager != null) {
                            ...
                            if (str != null) {
                                ...
                                C12880j.m40222a((Object) bytes, str4);
                            ...
                            C12880j.m40227c("licenseManager");
                            throw null;
                        }
                    }
            ...
            C12880j.m40222a((Object) a, "Result.failure()");
            return a;
        }
    }
}
