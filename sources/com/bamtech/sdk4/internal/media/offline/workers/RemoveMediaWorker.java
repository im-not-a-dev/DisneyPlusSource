...
public final class RemoveMediaWorker extends Worker {
    ...
    public Result doWork() {
        try {
            ...
            if (a != null) {
                Intrinsics.checkReturnedValueIsNotNull((Object) a, "inputData.getString(MEDI…on(\"Media ID is missing\")");
                ...
                if (provider != null) {
                    ...
                    Intrinsics.throwUninitializedPropertyAccessException("downloadSession");
                    throw null;
                }
            ...
            if (e instanceof IllegalStateException) {
                ...
                Intrinsics.checkReturnedValueIsNotNull((Object) b, "Result.retry()");
                return b;
            }
            Result a2 = Result.m5467a();
            Intrinsics.checkReturnedValueIsNotNull((Object) a2, "Result.failure()");
            return a2;
        }
    }
}
