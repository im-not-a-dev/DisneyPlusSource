...
public final class ExoCachedMedia implements CachedMedia, RenditionKeyProvider {
    ...
    private final long countBytesRecursive(File file, int i) {
        ...
        Intrinsics.checkReturnedValueIsNotNull((Object) listFiles, "file.listFiles()");
        for (File file2 : listFiles) {
            Intrinsics.checkReturnedValueIsNotNull((Object) file2, "it");
    ...
    public boolean equals(Object obj) {
        ...
        return (obj instanceof ExoCachedMedia) && !(Intrinsics.areEqual((Object) getId(), (Object) ((ExoCachedMedia) obj).getId()) ^ true);
    }
    ...
    public final String getLocalBifFile(Context context, Presentation presentation) {
        ...
        Intrinsics.checkReturnedValueIsNotNull((Object) absolutePath, "File(getThumbnailDirecto…            .absolutePath");
        return absolutePath;
    }
    ...
    public final List<String> getThumbnailFileNames(Context context) {
        ...
        Intrinsics.checkReturnedValueIsNotNull((Object) listFiles, "getThumbnailDirectory(co…             .listFiles()");
        ...
        while (true) {
            ...
            Intrinsics.checkReturnedValueIsNotNull((Object) file, str2);
        ...
        for (File file2 : arrayList2) {
            Intrinsics.checkReturnedValueIsNotNull((Object) file2, str2);
    ...
    public final void removeThumbnails(Context context) {
        ...
        for (File file : listFiles) {
            Intrinsics.checkReturnedValueIsNotNull((Object) file, "file");
            String name = file.getName();
            Intrinsics.checkReturnedValueIsNotNull((Object) name, "file.name");
            if (C12832w.m40123b(name, getId(), false, 2, null)) {
                file.delete();
            }
        }
