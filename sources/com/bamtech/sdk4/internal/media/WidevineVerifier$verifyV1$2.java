...
final class WidevineVerifier$verifyV1$2 extends C12881k implements Function1<Services, MediaServiceConfiguration> {
    public static final WidevineVerifier$verifyV1$2 INSTANCE = new WidevineVerifier$verifyV1$2();

    WidevineVerifier$verifyV1$2() {
        super(1);
    }
