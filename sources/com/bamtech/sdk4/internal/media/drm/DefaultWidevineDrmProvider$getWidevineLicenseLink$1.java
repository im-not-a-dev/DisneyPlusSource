...
final class DefaultWidevineDrmProvider$getWidevineLicenseLink$1 extends C12881k implements Function1<Services, TelemetryServiceConfiguration> {
    public static final DefaultWidevineDrmProvider$getWidevineLicenseLink$1 INSTANCE = new DefaultWidevineDrmProvider$getWidevineLicenseLink$1();

    DefaultWidevineDrmProvider$getWidevineLicenseLink$1() {
        super(1);
    }
