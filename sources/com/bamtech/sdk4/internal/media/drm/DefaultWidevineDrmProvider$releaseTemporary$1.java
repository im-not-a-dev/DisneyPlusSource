...
final class DefaultWidevineDrmProvider$releaseTemporary$1 extends C12881k implements Function1<Services, Link> {
    public static final DefaultWidevineDrmProvider$releaseTemporary$1 INSTANCE = new DefaultWidevineDrmProvider$releaseTemporary$1();

    DefaultWidevineDrmProvider$releaseTemporary$1() {
        super(1);
    }
