...
final class DefaultWidevineDrmProvider$releasePermanently$1 extends C12881k implements Function1<Services, Link> {
    public static final DefaultWidevineDrmProvider$releasePermanently$1 INSTANCE = new DefaultWidevineDrmProvider$releasePermanently$1();

    DefaultWidevineDrmProvider$releasePermanently$1() {
        super(1);
    }
