...
@Metadata(mo31005bv = {1, 0, 3}, mo31006d1 = {"\u0000 \n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0003\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0012\n\u0000\u0010\u0000\u001a\u00020\u00012\b\u0010\u0002\u001a\u0004\u0018\u00010\u00032\b\u0010\u0004\u001a\u0004\u0018\u00010\u00052\b\u0010\u0006\u001a\u0004\u0018\u00010\u00072\b\u0010\b\u001a\u0004\u0018\u00010\tH\n¢\u0006\u0002\b\n"}, mo31007d2 = {"<anonymous>", "", "response", "Lokhttp3/Response;", "throwable", "", "request", "Lokhttp3/Request;", "bytes", "", "invoke"}, mo31008k = 3, mo31009mv = {1, 1, 15})
/* compiled from: DefaultWidevineDrmProvider.kt */
final class DefaultWidevineDrmProvider$getWidevineLicense$1$qosCallback$1 extends C12881k implements Function4<Response, Throwable, Request, byte[], C13145v> {
    final /* synthetic */ DefaultWidevineDrmProvider$getWidevineLicense$1 this$0;

    DefaultWidevineDrmProvider$getWidevineLicense$1$qosCallback$1(DefaultWidevineDrmProvider$getWidevineLicense$1 defaultWidevineDrmProvider$getWidevineLicense$1) {
        this.this$0 = defaultWidevineDrmProvider$getWidevineLicense$1;
        super(4);
    }
    ...
    public final void invoke(okhttp3.Response r19, java.lang.Throwable r20, okhttp3.Request r21, byte[] r22) {
        /*
            r18 = this;
            r0 = r18
            com.bamtech.sdk4.internal.media.drm.DefaultWidevineDrmProvider$getWidevineLicense$1 r1 = r0.this$0
        ...
        L_0x0028:
            ...
            r7 = 0
            r8 = 0
            com.bamtech.sdk4.internal.media.drm.DefaultWidevineDrmProvider$getWidevineLicense$1 r5 = r0.this$0
            com.bamtech.sdk4.internal.media.drm.DefaultWidevineDrmProvider r5 = r5.this$0
        ...
        L_0x006f:
            r15 = r3
        L_0x0070:
            com.bamtech.sdk4.internal.media.drm.DefaultWidevineDrmProvider$getWidevineLicense$1 r2 = r0.this$0
            ...
            com.bamtech.sdk4.internal.media.drm.DefaultWidevineDrmProvider$getWidevineLicense$1 r2 = r0.this$0
            com.bamtech.sdk4.internal.media.drm.DefaultWidevineDrmProvider r2 = r2.this$0
            com.bamtech.sdk4.media.QOSNetworkHelper r2 = r2.qosNetworkHelper
            r5 = r20
            ...
            com.bamtech.sdk4.internal.media.drm.DefaultWidevineDrmProvider$getWidevineLicense$1 r6 = r0.this$0
            ...
            r10.<init>(r1, r6, r4)
            com.bamtech.sdk4.internal.media.drm.DefaultWidevineDrmProvider$getWidevineLicense$1 r1 = r0.this$0
            com.bamtech.sdk4.internal.media.drm.DefaultWidevineDrmProvider r1 = r1.this$0
            com.bamtech.sdk4.internal.telemetry.dust.DustClientConstants r11 = r1.dustConstants
            java.lang.String r8 = "urn:dss:event:fed:media:drm:key:fetched"
        ...
        L_0x00c5:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.bamtech.sdk4.internal.media.drm.DefaultWidevineDrmProvider$getWidevineLicense$1$qosCallback$1.invoke(okhttp3.Response, java.lang.Throwable, okhttp3.Request, byte[]):void");
    }
}
