...
final class DefaultPlayReadyDrmProvider$provisionPlayReady$2 extends C12881k implements Function1<Services, TelemetryServiceConfiguration> {
    public static final DefaultPlayReadyDrmProvider$provisionPlayReady$2 INSTANCE = new DefaultPlayReadyDrmProvider$provisionPlayReady$2();

    DefaultPlayReadyDrmProvider$provisionPlayReady$2() {
        super(1);
    }
