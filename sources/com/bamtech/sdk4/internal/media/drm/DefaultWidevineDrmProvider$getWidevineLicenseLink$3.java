...
final class DefaultWidevineDrmProvider$getWidevineLicenseLink$3 extends C12881k implements Function1<Services, Link> {
    public static final DefaultWidevineDrmProvider$getWidevineLicenseLink$3 INSTANCE = new DefaultWidevineDrmProvider$getWidevineLicenseLink$3();

    DefaultWidevineDrmProvider$getWidevineLicenseLink$3() {
        super(1);
    }
