...
final class TestWidevineDrmProvider$getWidevineLicenseLink$1 extends C12881k implements Function1<Services, Link> {
    public static final TestWidevineDrmProvider$getWidevineLicenseLink$1 INSTANCE = new TestWidevineDrmProvider$getWidevineLicenseLink$1();

    TestWidevineDrmProvider$getWidevineLicenseLink$1() {
        super(1);
    }
