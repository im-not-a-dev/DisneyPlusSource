...
final class DefaultWidevineDrmProvider$getWidevineLicenseLink$2<T, R> implements Function<T, R> {
    final /* synthetic */ String $url;

    DefaultWidevineDrmProvider$getWidevineLicenseLink$2(String str) {
        this.$url = str;
    }
    ...
    public final Pair<Link, TelemetryServiceConfiguration> apply(TelemetryServiceConfiguration telemetryServiceConfiguration) {
        return C12907r.m40244a(C1679a.m7776a(new Function1<Builder, C13145v>(this) {
            final /* synthetic */ DefaultWidevineDrmProvider$getWidevineLicenseLink$2 this$0;
