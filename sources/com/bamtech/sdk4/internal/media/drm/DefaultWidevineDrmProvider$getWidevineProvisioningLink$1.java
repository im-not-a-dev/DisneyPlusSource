...
final class DefaultWidevineDrmProvider$getWidevineProvisioningLink$1 extends C12881k implements Function1<Services, TelemetryServiceConfiguration> {
    public static final DefaultWidevineDrmProvider$getWidevineProvisioningLink$1 INSTANCE = new DefaultWidevineDrmProvider$getWidevineProvisioningLink$1();

    DefaultWidevineDrmProvider$getWidevineProvisioningLink$1() {
        super(1);
    }
