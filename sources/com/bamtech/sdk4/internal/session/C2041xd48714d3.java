...
/* renamed from: com.bamtech.sdk4.internal.session.DefaultSessionClient$getSessionInfo$2$$special$$inlined$responseTransformer$1 */
/* compiled from: ResponseHandlers.kt */
public final class C2041xd48714d3 extends C12881k implements Function1<Response, com.bamtech.core.networking.Response<? extends SessionInfo>> {
    final /* synthetic */ ResponseHandler[] $responseHandlers;
    final /* synthetic */ ServiceTransaction $transaction;

    public C2041xd48714d3(ResponseHandler[] responseHandlerArr, ServiceTransaction serviceTransaction) {
        this.$responseHandlers = responseHandlerArr;
        this.$transaction = serviceTransaction;
        super(1);
    }

    public final com.bamtech.core.networking.Response<SessionInfo> invoke(Response response) {
