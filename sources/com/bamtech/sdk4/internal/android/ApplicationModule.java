...
public final class ApplicationModule {
    public final SharedPreferences cookiePreferences(Application application) {
        ...
        Intrinsics.checkReturnedValueIsNotNull((Object) sharedPreferences, "application.getSharedPre…IE, Context.MODE_PRIVATE)");
    ...
    public final SharedPreferences sharedPreferences(Application application) {
        ...
        Intrinsics.checkReturnedValueIsNotNull((Object) sharedPreferences, "application.getSharedPre…ME, Context.MODE_PRIVATE)");
        return sharedPreferences;
    }
}
