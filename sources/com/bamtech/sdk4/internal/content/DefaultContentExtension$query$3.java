...
final class DefaultContentExtension$query$3<T, R> implements Function<T, SingleSource<? extends R>> {
    ...
    DefaultContentExtension$query$3(DefaultContentExtension defaultContentExtension, ServiceTransaction serviceTransaction, GraphQlRequest graphQlRequest, Class cls, SearchOverrides searchOverrides, String str) {
