...
final class DefaultContentClient$query$2 extends C12881k implements Function1<Services, TelemetryServiceConfiguration> {
    public static final DefaultContentClient$query$2 INSTANCE = new DefaultContentClient$query$2();

    DefaultContentClient$query$2() {
        super(1);
    }
