...
public final class DefaultContentClient$query$3$$special$$inlined$toSingle$3<T> implements Consumer<Throwable> {
    final /* synthetic */ String $dustEvent;
    final /* synthetic */ Request $this_toSingle;
    final /* synthetic */ ServiceTransaction $transaction;

    public DefaultContentClient$query$3$$special$$inlined$toSingle$3(Request request, ServiceTransaction serviceTransaction, String str) {
