...
public final class StreamSampleTelemetryClient implements TelemetryClient {
    ...
    public StreamSampleTelemetryClient(ConfigurationProvider configurationProvider2, ConverterProvider converterProvider) {
    ...
    public Single<TelemetryResponse> postEvents(ServiceTransaction serviceTransaction, Map<String, String> map, String str) {
        Single<TelemetryResponse> a = this.configurationProvider.getServiceLink(serviceTransaction, StreamSampleTelemetryClient$postEvents$1.INSTANCE).mo30208a((Function<? super T, ? extends SingleSource<? extends R>>) new StreamSampleTelemetryClient$postEvents$2<Object,Object>(this, map, serviceTransaction, str));
        Intrinsics.checkReturnedValueIsNotNull((Object) a, "configurationProvider.ge…SAMPLE)\n                }");
        return a;
    }
}
