...
final class DustEventBuffer$initialize$3<T> implements C11952h<TelemetryProcessingRequest> {
    final /* synthetic */ DustEventBuffer this$0;

    DustEventBuffer$initialize$3(DustEventBuffer dustEventBuffer) {
        this.this$0 = dustEventBuffer;
    }

    public final boolean test(TelemetryProcessingRequest telemetryProcessingRequest) {
        return telemetryProcessingRequest.isOneOffRequest() || telemetryProcessingRequest.isFastTrackRequest() || !this.this$0.isProcessing.getAndSet(true);
    }
}
