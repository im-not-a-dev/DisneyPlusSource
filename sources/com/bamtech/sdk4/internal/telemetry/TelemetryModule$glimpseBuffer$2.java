...
final class TelemetryModule$glimpseBuffer$2 extends C12881k implements Function1<TelemetryServiceExtras, TelemetryBufferConfiguration> {
    public static final TelemetryModule$glimpseBuffer$2 INSTANCE = new TelemetryModule$glimpseBuffer$2();

    TelemetryModule$glimpseBuffer$2() {
        super(1);
    }

    public final TelemetryBufferConfiguration invoke(TelemetryServiceExtras telemetryServiceExtras) {
        return telemetryServiceExtras.getGlimpseConfiguration();
    }
}
