...
final class TelemetryModule$glimpseBuffer$1 extends C12881k implements Function1<Services, TelemetryServiceExtras> {
    public static final TelemetryModule$glimpseBuffer$1 INSTANCE = new TelemetryModule$glimpseBuffer$1();

    TelemetryModule$glimpseBuffer$1() {
        super(1);
    }
