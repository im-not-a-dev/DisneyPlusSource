...
final class TelemetryModule$qosBuffer$1 extends C12881k implements Function1<Services, TelemetryServiceExtras> {
    public static final TelemetryModule$qosBuffer$1 INSTANCE = new TelemetryModule$qosBuffer$1();

    TelemetryModule$qosBuffer$1() {
        super(1);
    }
