...
final class TelemetryModule$telemetryBuffer$2 extends C12881k implements Function1<TelemetryServiceExtras, TelemetryBufferConfiguration> {
    public static final TelemetryModule$telemetryBuffer$2 INSTANCE = new TelemetryModule$telemetryBuffer$2();

    TelemetryModule$telemetryBuffer$2() {
        super(1);
    }

    public final TelemetryBufferConfiguration invoke(TelemetryServiceExtras telemetryServiceExtras) {
        return telemetryServiceExtras.getStreamSampleConfiguration();
    }
}
