...
final class TelemetryModule$telemetryBuffer$1 extends C12881k implements Function1<Services, TelemetryServiceExtras> {
    public static final TelemetryModule$telemetryBuffer$1 INSTANCE = new TelemetryModule$telemetryBuffer$1();

    TelemetryModule$telemetryBuffer$1() {
        super(1);
    }
