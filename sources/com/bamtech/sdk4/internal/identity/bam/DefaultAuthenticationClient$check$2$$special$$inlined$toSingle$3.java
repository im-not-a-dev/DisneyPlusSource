...
public final class DefaultAuthenticationClient$check$2$$special$$inlined$toSingle$3<T> implements Consumer<Throwable> {
    final /* synthetic */ String $dustEvent;
    final /* synthetic */ Request $this_toSingle;
    final /* synthetic */ ServiceTransaction $transaction;

    public DefaultAuthenticationClient$check$2$$special$$inlined$toSingle$3(Request request, ServiceTransaction serviceTransaction, String str) {
