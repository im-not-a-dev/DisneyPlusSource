...
final class DefaultPasswordClient$changeEmail$1 extends C12881k implements Function1<Services, Link> {
    public static final DefaultPasswordClient$changeEmail$1 INSTANCE = new DefaultPasswordClient$changeEmail$1();

    DefaultPasswordClient$changeEmail$1() {
        super(1);
    }
