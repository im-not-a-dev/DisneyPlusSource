...
public final class DefaultAuthenticationClient$check$2$$special$$inlined$toSingle$2<T> implements Consumer<Disposable> {
    final /* synthetic */ String $dustEvent;
    final /* synthetic */ ServiceTransaction $transaction;

    public DefaultAuthenticationClient$check$2$$special$$inlined$toSingle$2(ServiceTransaction serviceTransaction, String str) {
