...
final class DefaultAuthenticationClient$authenticate$1 extends C12881k implements Function1<Services, Link> {
    public static final DefaultAuthenticationClient$authenticate$1 INSTANCE = new DefaultAuthenticationClient$authenticate$1();

    DefaultAuthenticationClient$authenticate$1() {
        super(1);
    }
