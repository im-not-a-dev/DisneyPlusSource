...
final class DefaultAuthenticationClient$check$1 extends C12881k implements Function1<Services, Link> {
    public static final DefaultAuthenticationClient$check$1 INSTANCE = new DefaultAuthenticationClient$check$1();

    DefaultAuthenticationClient$check$1() {
        super(1);
    }
