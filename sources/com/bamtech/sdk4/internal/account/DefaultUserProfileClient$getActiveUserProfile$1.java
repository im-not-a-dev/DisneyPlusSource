...
final class DefaultUserProfileClient$getActiveUserProfile$1 extends C12881k implements Function1<Services, Link> {
    public static final DefaultUserProfileClient$getActiveUserProfile$1 INSTANCE = new DefaultUserProfileClient$getActiveUserProfile$1();

    DefaultUserProfileClient$getActiveUserProfile$1() {
        super(1);
    }
