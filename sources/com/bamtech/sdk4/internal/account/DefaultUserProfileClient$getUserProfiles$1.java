...
final class DefaultUserProfileClient$getUserProfiles$1 extends C12881k implements Function1<Services, Link> {
    public static final DefaultUserProfileClient$getUserProfiles$1 INSTANCE = new DefaultUserProfileClient$getUserProfiles$1();

    DefaultUserProfileClient$getUserProfiles$1() {
        super(1);
    }
