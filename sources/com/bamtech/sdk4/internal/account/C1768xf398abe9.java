...
/* renamed from: com.bamtech.sdk4.internal.account.DefaultCreateAccountClient$createAccount$2$$special$$inlined$responseTransformer$1 */
/* compiled from: ResponseHandlers.kt */
public final class C1768xf398abe9 extends C12881k implements Function1<Response, com.bamtech.core.networking.Response<? extends CreateAccountResult>> {
    final /* synthetic */ ResponseHandler[] $responseHandlers;
    final /* synthetic */ ServiceTransaction $transaction;

    public C1768xf398abe9(ResponseHandler[] responseHandlerArr, ServiceTransaction serviceTransaction) {
        this.$responseHandlers = responseHandlerArr;
        this.$transaction = serviceTransaction;
        super(1);
    }

    public final com.bamtech.core.networking.Response<CreateAccountResult> invoke(Response response) {
