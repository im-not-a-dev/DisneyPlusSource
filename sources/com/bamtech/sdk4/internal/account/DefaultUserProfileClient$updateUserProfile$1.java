...
final class DefaultUserProfileClient$updateUserProfile$1 extends C12881k implements Function1<Services, Link> {
    public static final DefaultUserProfileClient$updateUserProfile$1 INSTANCE = new DefaultUserProfileClient$updateUserProfile$1();

    DefaultUserProfileClient$updateUserProfile$1() {
        super(1);
    }
