...
/* renamed from: com.bamtech.sdk4.internal.subscription.DefaultSubscriptionClient$getSubscriptions$2$$special$$inlined$responseTransformer$1 */
/* compiled from: ResponseHandlers.kt */
public final class C2050xbb877ddc extends C12881k implements Function1<Response, com.bamtech.core.networking.Response<? extends Collection>> {
    final /* synthetic */ ResponseHandler[] $responseHandlers;
    final /* synthetic */ ServiceTransaction $transaction;

    public C2050xbb877ddc(ResponseHandler[] responseHandlerArr, ServiceTransaction serviceTransaction) {
        this.$responseHandlers = responseHandlerArr;
        this.$transaction = serviceTransaction;
        super(1);
    }

    public final com.bamtech.core.networking.Response<Collection> invoke(Response response) {
