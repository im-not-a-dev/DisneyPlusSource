...
public final class DefaultDeviceClient$register$1$2$$special$$inlined$toSingle$2<T> implements Consumer<Disposable> {
    final /* synthetic */ String $dustEvent;
    final /* synthetic */ ServiceTransaction $transaction;

    public DefaultDeviceClient$register$1$2$$special$$inlined$toSingle$2(ServiceTransaction serviceTransaction, String str) {
