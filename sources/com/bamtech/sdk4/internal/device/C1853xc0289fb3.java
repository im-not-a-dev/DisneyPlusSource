...
/* renamed from: com.bamtech.sdk4.internal.device.DefaultDeviceClient$register$1$2$$special$$inlined$responseTransformer$1 */
/* compiled from: ResponseHandlers.kt */
public final class C1853xc0289fb3 extends C12881k implements Function1<Response, com.bamtech.core.networking.Response<? extends Success>> {
    final /* synthetic */ ResponseHandler[] $responseHandlers;
    final /* synthetic */ ServiceTransaction $transaction;

    public C1853xc0289fb3(ResponseHandler[] responseHandlerArr, ServiceTransaction serviceTransaction) {
        this.$responseHandlers = responseHandlerArr;
        this.$transaction = serviceTransaction;
        super(1);
    }

    public final com.bamtech.core.networking.Response<Success> invoke(Response response) {
