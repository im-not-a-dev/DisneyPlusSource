        ...
        if (this != obj) {
            if (obj instanceof DrmExtras) {
                ...
                if (this.minimumRenewalFrequency == drmExtras.minimumRenewalFrequency) {
                    if (!(this.playReadyPreferred == drmExtras.playReadyPreferred) || !Intrinsics.areEqual((Object) this.widevineCheckKidBase64, (Object) drmExtras.widevineCheckKidBase64)) {
                        return false;
                    }
                }
            }
