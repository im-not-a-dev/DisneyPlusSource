...
public final class DefaultPurchaseClient$execute$1$$special$$inlined$toSingle$2<T> implements Consumer<Disposable> {
    final /* synthetic */ String $dustEvent;
    final /* synthetic */ ServiceTransaction $transaction;

    public DefaultPurchaseClient$execute$1$$special$$inlined$toSingle$2(ServiceTransaction serviceTransaction, String str) {
