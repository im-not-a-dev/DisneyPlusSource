...
final class DefaultPurchaseManager$redeemReceipt$1 extends C12881k implements Function2<Map<String, ? extends String>, ReceiptClaimBody, Single<? extends PurchaseActivationResult>> {
    final /* synthetic */ ServiceTransaction $transaction;
    final /* synthetic */ DefaultPurchaseManager this$0;

    DefaultPurchaseManager$redeemReceipt$1(DefaultPurchaseManager defaultPurchaseManager, ServiceTransaction serviceTransaction) {
    ...
    public final Single<? extends PurchaseActivationResult> invoke(Map<String, String> map, ReceiptClaimBody receiptClaimBody) {
        return this.this$0.client.redeem(this.$transaction, map, receiptClaimBody);
    }
}
