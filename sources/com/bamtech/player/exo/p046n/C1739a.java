...
public class C1739a extends C9295d {
    ...
    public C9312a[] mo7774a(C9307a aVar, int[][][] iArr, int[] iArr2, C9299d dVar) {
        ...
        this.f6025h = a;
        mo7768a(a);
        Intrinsics.checkReturnedValueIsNotNull((Object) a, "selections");
        return a;
    }
    ...
    public final List<C5290d> mo7786f() {
        ...
        if (c != null) {
            ...
            for (int i = 0; i < a; i++) {
                ...
                Intrinsics.checkReturnedValueIsNotNull((Object) b, "this.getTrackGroups(trackGroupIndex)");
                int i2 = b.f20170c;
                for (int i3 = 0; i3 < i2; i3++) {
                    C9199j0 a2 = b.mo23531a(i3);
                    Intrinsics.checkReturnedValueIsNotNull((Object) a2, "this.get(trackGroupIndex)");
                    int i4 = a2.f20833c;
                    for (int i5 = 0; i5 < i4; i5++) {
                        Format a3 = a2.mo23902a(i5);
                        Intrinsics.checkReturnedValueIsNotNull((Object) a3, "this.getFormat(formatIndex)");
    ...
    public Pair<C9312a, C9298c> mo7758a(TrackGroupArray trackGroupArray, int[][] iArr, int i, C9299d dVar, boolean z) {
        ...
        Object obj = a.first;
        Intrinsics.checkReturnedValueIsNotNull(obj, "audioSelection.first");
    ...
    public final void mo7783c(String str) {
        if (!Intrinsics.areEqual((Object) mo24087e().f21300U, (Object) str)) {
    ...
    public final int[][] mo7775a(TrackGroupArray trackGroupArray, int[][] iArr) {
        if (this.f6033p && trackGroupArray != null) {
            ...
            for (int i2 = 0; i2 < i; i2++) {
                ...
                Intrinsics.checkReturnedValueIsNotNull((Object) a, "this.get(trackGroupIndex)");
                int i3 = a.f20833c;
                for (int i4 = 0; i4 < i3; i4++) {
                    Format a2 = a.mo23902a(i4);
                    Intrinsics.checkReturnedValueIsNotNull((Object) a2, "this.getFormat(formatIndex)");
    ...
    public final void mo7780b(String str) {
        if (!Intrinsics.areEqual((Object) mo24087e().f21304c, (Object) str)) {
    ...
    public final Format mo7776b(int i) {
        ...
        C9312a aVar = null;
        if (c != null) {
            Intrinsics.checkReturnedValueIsNotNull((Object) c, "mappedInfo");
    ...
    public final void mo7766a(Function1<? super C9301e, C13145v> function1) {
        C9301e d = mo24086d();
        Intrinsics.checkReturnedValueIsNotNull((Object) d, "paramBuilder");
        function1.invoke(d);
        mo24085a(d);
    }
        ...
        if (trackGroupArray != null) {
            ...
            for (int i2 = 0; i2 < i; i2++) {
                ...
                while (i4 < i3) {
                    Format a2 = a.mo23902a(i4);
                    Intrinsics.checkReturnedValueIsNotNull((Object) a2, "this.getFormat(formatIndex)");
                    if (!Intrinsics.areEqual((Object) a2.f18368t0, (Object) str) || !mo7769a(a2.f18344W, this.f6032o) || C1744b.m8094d(a2)) {
                        i4++;
                    } else {
