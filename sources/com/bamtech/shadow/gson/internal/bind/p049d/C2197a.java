package com.bamtech.shadow.gson.internal.bind.p049d;

import java.util.TimeZone;

/* renamed from: com.bamtech.shadow.gson.internal.bind.d.a */
/* compiled from: ISO8601Utils */
public class C2197a {

    /* renamed from: a */
    private static final TimeZone f6291a = TimeZone.getTimeZone("UTC");
    ...
    public static java.util.Date m8534a(java.lang.String r18, java.text.ParsePosition r19) throws java.text.ParseException {
        /*
            r1 = r18
            r2 = r19
            java.lang.String r3 = "'"
            ...
            int r4 = r0 + 4
            int r0 = m8533a(r1, r0, r4)     // Catch:{ IndexOutOfBoundsException -> 0x01bf, NumberFormatException -> 0x01bd, IllegalArgumentException -> 0x01bb }
            r5 = 45
            boolean r6 = m8535a(r1, r4, r5)     // Catch:{ IndexOutOfBoundsException -> 0x01bf, NumberFormatException -> 0x01bd, IllegalArgumentException -> 0x01bb }
            if (r6 == 0) goto L_0x001a
            int r4 = r4 + 1
        L_0x001a:
            int r6 = r4 + 2
            int r4 = m8533a(r1, r4, r6)     // Catch:{ IndexOutOfBoundsException -> 0x01bf, NumberFormatException -> 0x01bd, IllegalArgumentException -> 0x01bb }
            boolean r7 = m8535a(r1, r6, r5)     // Catch:{ IndexOutOfBoundsException -> 0x01bf, NumberFormatException -> 0x01bd, IllegalArgumentException -> 0x01bb }
            if (r7 == 0) goto L_0x0028
            int r6 = r6 + 1
        L_0x0028:
            int r7 = r6 + 2
            int r6 = m8533a(r1, r6, r7)     // Catch:{ IndexOutOfBoundsException -> 0x01bf, NumberFormatException -> 0x01bd, IllegalArgumentException -> 0x01bb }
            r8 = 84
            boolean r8 = m8535a(r1, r7, r8)     // Catch:{ IndexOutOfBoundsException -> 0x01bf, NumberFormatException -> 0x01bd, IllegalArgumentException -> 0x01bb }
            r9 = 1
        ...
        L_0x004b:
            ...
            int r7 = r7 + 1
            int r8 = r7 + 2
            int r7 = m8533a(r1, r7, r8)     // Catch:{ IndexOutOfBoundsException -> 0x01bf, NumberFormatException -> 0x01bd, IllegalArgumentException -> 0x01bb }
            r14 = 58
            boolean r15 = m8535a(r1, r8, r14)     // Catch:{ IndexOutOfBoundsException -> 0x01bf, NumberFormatException -> 0x01bd, IllegalArgumentException -> 0x01bb }
            if (r15 == 0) goto L_0x0064
            int r8 = r8 + 1
        L_0x0064:
            int r15 = r8 + 2
            int r8 = m8533a(r1, r8, r15)     // Catch:{ IndexOutOfBoundsException -> 0x01bf, NumberFormatException -> 0x01bd, IllegalArgumentException -> 0x01bb }
            boolean r14 = m8535a(r1, r15, r14)     // Catch:{ IndexOutOfBoundsException -> 0x01bf, NumberFormatException -> 0x01bd, IllegalArgumentException -> 0x01bb }
        ...
        L_0x0072:
            ...
            int r14 = r15 + 2
            int r15 = m8533a(r1, r15, r14)     // Catch:{ IndexOutOfBoundsException -> 0x01bf, NumberFormatException -> 0x01bd, IllegalArgumentException -> 0x01bb }
            r12 = 59
        ...
        L_0x0094:
            r15 = 46
            boolean r15 = m8535a(r1, r14, r15)     // Catch:{ IndexOutOfBoundsException -> 0x01bf, NumberFormatException -> 0x01bd, IllegalArgumentException -> 0x01bb }
            if (r15 == 0) goto L_0x00bc
            int r14 = r14 + 1
            int r15 = r14 + 1
            int r15 = m8532a(r1, r15)     // Catch:{ IndexOutOfBoundsException -> 0x01bf, NumberFormatException -> 0x01bd, IllegalArgumentException -> 0x01bb }
            int r5 = r14 + 3
            ...
            int r17 = m8533a(r1, r14, r5)     // Catch:{ IndexOutOfBoundsException -> 0x01bf, NumberFormatException -> 0x01bd, IllegalArgumentException -> 0x01bb }
            int r5 = r5 - r14
        ...
        L_0x00c6:
            ...
            java.util.TimeZone r10 = f6291a     // Catch:{ IndexOutOfBoundsException -> 0x01bf, NumberFormatException -> 0x01bd, IllegalArgumentException -> 0x01bb }
            int r15 = r15 + r9
            goto L_0x0181
        L_0x00d8:
        ...
        L_0x017c:
            ...
            goto L_0x0181
        L_0x017e:
            java.util.TimeZone r9 = f6291a     // Catch:{ IndexOutOfBoundsException -> 0x01bf, NumberFormatException -> 0x01bd, IllegalArgumentException -> 0x01bb }
            r10 = r9
        L_0x0181:
        ...
        L_0x0202:
            ...
            throw r4
        */
        throw new UnsupportedOperationException("Method not decompiled: com.bamtech.shadow.gson.internal.bind.p049d.C2197a.m8534a(java.lang.String, java.text.ParsePosition):java.util.Date");
    }

    /* renamed from: a */
    private static boolean m8535a(String str, int i, char c) {
        return i < str.length() && str.charAt(i) == c;
    }

    /* renamed from: a */
    private static int m8533a(String str, int i, int i2) throws NumberFormatException {
        int i3;
        int i4;
    ...
    /* renamed from: a */
    private static int m8532a(String str, int i) {
        while (i < str.length()) {
