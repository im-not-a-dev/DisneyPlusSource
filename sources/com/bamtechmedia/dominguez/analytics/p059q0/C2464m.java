...
public final class C2464m implements C2467o {
    ...
    public String mo11587a() {
        ...
        Intrinsics.checkReturnedValueIsNotNull((Object) string, "sharedPrefs.getString(SUBSCRIPTION_STATE, \"\")");
        return string;
    }
    ...
    public String mo11589b() {
        ...
        Intrinsics.checkReturnedValueIsNotNull((Object) string, "sharedPrefs.getString(USER_VISITOR_STATE, \"\")");
        return string;
    }
