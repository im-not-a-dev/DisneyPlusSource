...
public final class C3444j {
    ...
    public C3444j(ContainerType containerType, int i, int i2, int i3, boolean z, String str, String str2, boolean z2, int i4, int i5, C3623a aVar, boolean z3, String str3, String str4, String str5, float f, String str6, List<String> list, C3343b bVar) {
        ...
        while (true) {
            ...
            pVar = values[i7];
            if (Intrinsics.areEqual((Object) pVar.mo12645a(), (Object) this.f8682i)) {
                break;
            }
            i7++;
        }
        ...
        while (true) {
            ...
            aVar2 = values2[i6];
            if (Intrinsics.areEqual((Object) aVar2.mo12641a(), (Object) this.f8692s)) {
                break;
            }
            i6++;
        }
    ...
    public boolean equals(Object obj) {
        if (this != obj) {
            if (obj instanceof C3444j) {
                ...
                if (Intrinsics.areEqual((Object) this.f8676c, (Object) jVar.f8676c)) {
                    if (this.f8677d == jVar.f8677d) {
                        if (this.f8678e == jVar.f8678e) {
                            if (this.f8679f == jVar.f8679f) {
                                if ((this.f8680g == jVar.f8680g) && Intrinsics.areEqual((Object) this.f8681h, (Object) jVar.f8681h) && Intrinsics.areEqual((Object) this.f8682i, (Object) jVar.f8682i)) {
                                    if (this.f8683j == jVar.f8683j) {
                                        if (this.f8684k == jVar.f8684k) {
                                            if ((this.f8685l == jVar.f8685l) && Intrinsics.areEqual((Object) this.f8686m, (Object) jVar.f8686m)) {
                                                if (!(this.f8687n == jVar.f8687n) || !Intrinsics.areEqual((Object) this.f8688o, (Object) jVar.f8688o) || !Intrinsics.areEqual((Object) this.f8689p, (Object) jVar.f8689p) || !Intrinsics.areEqual((Object) this.f8690q, (Object) jVar.f8690q) || Float.compare(this.f8691r, jVar.f8691r) != 0 || !Intrinsics.areEqual((Object) this.f8692s, (Object) jVar.f8692s) || !Intrinsics.areEqual((Object) this.f8693t, (Object) jVar.f8693t) || !Intrinsics.areEqual((Object) this.f8694u, (Object) jVar.f8694u)) {
                                                    return false;
                                                }
                                            }
                                        }
