...
public final class AssetStaticImageHandler extends C5733a implements C0710d {
    ...
    static final class C3258f implements AnimatorUpdateListener {
        ...
        public final void onAnimationUpdate(ValueAnimator valueAnimator) {
            ...
            Intrinsics.checkReturnedValueIsNotNull((Object) valueAnimator, "valueAnimator");
    ...
    static final class C3263k<T> implements Consumer<Throwable> {
        ...
        public final void accept(Throwable th) {
            Timber.m44526b("Prefetch failed", new Object[0]);
        }
    }
    ...
    static final class C3268p extends C12881k implements Function2<ImageView, ImageView, AnimatorSet> {
        ...
        public static final class C3269a extends AnimatorListenerAdapter {
            ...
            public void onAnimationEnd(Animator animator) {
                super.onAnimationEnd(animator);
                Timber.m44521a("AssetTransitionHandler").mo35673d("Animation to static image end", new Object[0]);
    ...
    public final void mo12300y() {
        Timber.m44521a("AssetTransitionHandler").mo35673d("Hide hero view before VideoArt playback", new Object[0]);
    ...
    public final void mo12301z() {
        Timber.m44521a("AssetTransitionHandler").mo35673d("Show hero view after VideoArt playback", new Object[0]);
        C3254b bVar = this.f8267c;
        if (bVar != null) {
            ImageView i = bVar.mo12234i();
            if (i != null) {
    ...
    public final void m11264b(C3626b bVar, Function1<? super C3626b, C13145v> function1) {
        if (!Intrinsics.areEqual((Object) this.f8262W, (Object) bVar)) {
            Timber.m44521a("AssetTransitionHandler").mo35673d("Animation to static image start", new Object[0]);
            this.f8262W = bVar;
    ...
    public final void mo12298a(C3626b bVar, Function1<? super C3626b, C13145v> function1) {
        Timber.m44521a("AssetTransitionHandler").mo35673d("Schedule animation to static image", new Object[0]);
        m11269h(bVar);
        if (Intrinsics.areEqual((Object) bVar, (Object) this.f8263X)) {
            m11266e(bVar);
            this.f8263X = null;
        }
        ...
        Intrinsics.checkReturnedValueIsNotNull((Object) a, "Completable.timer(DURATI…dSchedulers.mainThread())");
        Object a2 = a.mo30048a((C11912b<? extends R>) C11793e.m37930a(getViewModelScope()));
        Intrinsics.checkReturnedValueIsNotNull(a2, "this.`as`(AutoDispose.au…isposable<Any>(provider))");
    ...
    private final ValueAnimator m11262b(View... viewArr) {
        ...
        Intrinsics.checkReturnedValueIsNotNull((Object) ofFloat, "it");
        ofFloat.setInterpolator(new LinearInterpolator());
        ofFloat.setDuration(150);
        ofFloat.addUpdateListener(new C3261i(viewArr));
        Intrinsics.checkReturnedValueIsNotNull((Object) ofFloat, "ValueAnimator.ofFloat(st…}\n            }\n        }");
        return ofFloat;
    }
    ...
    public final AnimatorSet m11255a(ImageView imageView, ImageView imageView2) {
        ...
        Intrinsics.checkReturnedValueIsNotNull((Object) context, "heroImageView.context");
    ...
    private final ValueAnimator m11257a(View... viewArr) {
        ...
        Intrinsics.checkReturnedValueIsNotNull((Object) ofFloat, "ValueAnimator.ofFloat(AL…}\n            }\n        }");
        return ofFloat;
    }
