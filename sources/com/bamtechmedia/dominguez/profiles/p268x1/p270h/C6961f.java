...
/* renamed from: com.bamtechmedia.dominguez.profiles.x1.h.f */
/* compiled from: LanguageUiSelection.kt */
public final class C6961f implements C6959d {
    /* renamed from: a */
    public List<C11866a> mo19709a(C6955a aVar, C6960e eVar) {
        List<Pair> a = aVar.mo19702a();
        ArrayList arrayList = new ArrayList(C13187p.m40525a((Iterable) a, 10));
        for (Pair pair : a) {
            arrayList.add(new C6962g((String) pair.mo31015c(), ((Boolean) pair.mo31016d()).booleanValue(), eVar));
        }
        return arrayList;
    }
}
