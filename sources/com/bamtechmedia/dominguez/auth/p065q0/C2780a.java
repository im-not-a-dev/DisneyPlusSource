...
public final class C2780a implements C2783b {
    ...
    public Completable mo11569a() {
        ...
        C12880j.m40222a(obj, "delegates.get()");
        ...
        for (C2783b bVar : iterable) {
            ...
            C12880j.m40222a((Object) a, "it.onLogin().timeout(ACT…SECONDS, Schedulers.io())");
            C12880j.m40222a((Object) bVar.getClass().getSimpleName(), "it.javaClass.simpleName");
            arrayList.add(a);
        }
        ...
        C12880j.m40222a((Object) a2, "Completable.mergeDelayEr…oOnError { Timber.e(it) }");
        return a2;
    }
}
