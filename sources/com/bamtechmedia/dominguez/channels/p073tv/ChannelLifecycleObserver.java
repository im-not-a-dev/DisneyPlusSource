...
public final class ChannelLifecycleObserver implements C0710d {
    ...
    public void mo4127b(C0722m mVar) {
        ...
        Intrinsics.checkReturnedValueIsNotNull((Object) b, "collectionInvalidator.in…ubscribeOn(mainScheduler)");
        C0715i lifecycle = mVar.getLifecycle();
        Intrinsics.checkReturnedValueIsNotNull((Object) lifecycle, "owner.lifecycle");
