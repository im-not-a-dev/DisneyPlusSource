    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (action != null && action.hashCode() == 1568780589 && action.equals("android.media.tv.action.PREVIEW_PROGRAM_BROWSABLE_DISABLED")) {
            ...
            if (eVar != null) {
                ...
                if (aVar != null) {
                    C12880j.m40222a((Object) b, "program");
                    String d = b.mo15141d();
                    C12880j.m40222a((Object) d, "program.internalProviderId");
                    aVar.mo12264a(d);
                    StringBuilder sb2 = new StringBuilder();
                    sb2.append("onReceive: ACTION_PREVIEW_PROGRAM_BROWSABLE_DISABLED program: ");
                    sb2.append(b);
                    sb2.append(' ');
                    C14100a.m44522a(sb2.toString(), new Object[0]);
                    return;
                }
                C12880j.m40227c("deletedProgramsIdStore");
                throw null;
            }
            C12880j.m40227c("previewChannelHelper");
            throw null;
        }
    }
}
