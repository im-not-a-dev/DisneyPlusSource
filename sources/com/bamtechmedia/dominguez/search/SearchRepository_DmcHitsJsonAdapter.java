...
public final class SearchRepository_DmcHitsJsonAdapter extends C11725h<DmcHits> {
    ...
    public SearchRepository_DmcHitsJsonAdapter(C11760v vVar) {
        ...
        C12880j.m40222a((Object) a, "JsonReader.Options.of(\"h…sType\", \"meta\", \"assets\")");
        this.options = a;
        ...
        C12880j.m40222a((Object) a5, "moshi.adapter<List<Asset…ons.emptySet(), \"assets\")");
