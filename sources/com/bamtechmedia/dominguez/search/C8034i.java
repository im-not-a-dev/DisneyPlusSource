...
public final class C8034i {
    ...
    static final class C8038c<T> implements Consumer<Throwable> {
        ...
        public final void accept(Throwable th) {
            Timber.m44528b(th, "Failed to load recents from disk", new Object[0]);
        }
    }
    ...
    static final class C8042g<T> implements Consumer<Map<String, ? extends RecentSearchList>> {
        ...
        public final void accept(Map<String, RecentSearchList> map) {
            Intrinsics.checkReturnedValueIsNotNull((Object) map, "cachedMap");
    ...
    public final Maybe<Map<String, RecentSearchList>> m23351d() {
        ...
        Intrinsics.checkReturnedValueIsNotNull((Object) b, "Maybe\n        .fromCalla…t) ?: mapOf() }\n        }");
        return b;
    }
    ...
    private final Single<C6626c0> m23350c() {
        ...
        Intrinsics.checkReturnedValueIsNotNull((Object) d, "Maybe.fromCallable { cac…ss { cachedProfile = it }");
        return d;
    }
    ...
    public final Maybe<RecentSearchList> mo21018a() {
        ...
        Intrinsics.checkReturnedValueIsNotNull((Object) b, "getActiveProfile()\n     ….subscribeOn(ioScheduler)");
        return b;
    }
