...
public final class C6144q extends C5733a implements C10582k, C7630d {
    ...
    static final class C6149e<T, R> implements Function<T, SingleSource<? extends R>> {
        ...
        public final Single<? extends C6219d> apply(SessionInfo sessionInfo) {
            if (sessionInfo.isSubscriber()) {
                ...
                C12880j.m40222a((Object) b, "Single.just(Subscribed)");
                return b;
            }
    ...
    static final class C6160p<T, R> implements Function<T, MaybeSource<? extends R>> {
        ...
        static final class C6161a<T> implements Consumer<Throwable> {
            ...
            /* renamed from: a */
            public final void accept(Throwable th) {
                C14100a.m44524a(th, "createProfileLanguageSetup setValues failed", new Object[0]);
            }
        }
    ...
    public C6144q(C6181d dVar, C6234e eVar, Provider<C6766q1> provider, Provider<C3291a> provider2, C2793c cVar, C6136l lVar, Single<SessionInfo> single, Provider<C6864d> provider3, Provider<C6722l1> provider4, C11969r rVar, C7930a aVar, C2746g gVar, C11868a<C6206a> aVar2, Provider<C7300k> provider5, C7301l lVar2) {
        ...
        C12880j.m40222a((Object) a, "completableSubject\n     …hen(stateHolder.stream())");
    ...
    private final void m19578B() {
        ...
        C12880j.m40222a((Object) a, "startupProfileProvider.g…veOn(mainThreadScheduler)");
    ...
    private final void m19598y() {
        ...
        C12880j.m40222a((Object) a, "sessionInfoOnce.flatMap …)\n            }\n        }");
    ...
    public void mo11889f() {
        if (C12880j.m40224a((Object) this.f14124W.mo18827a(), (Object) C6222c.f14258a)) {
    ...
    public final void m19586a(C6219d dVar) {
        ...
        } else if (C12880j.m40224a((Object) dVar, (Object) C6231l.f14268a)) {
            m19585a(this, null, 1, null);
            vVar = C13145v.f29587a;
        } else if (C12880j.m40224a((Object) dVar, (Object) C6225f.f14262a)) {
            m19599z();
            this.f14135g0.mo11574b("not Active");
            vVar = C13145v.f29587a;
        } else if (C12880j.m40224a((Object) dVar, (Object) C6224e.f14261a)) {
            m19598y();
            vVar = C13145v.f29587a;
        } else if (C12880j.m40224a((Object) dVar, (Object) C6227h.f14264a)) {
            m19577A();
            vVar = C13145v.f29587a;
        } else if (C12880j.m40224a((Object) dVar, (Object) C6226g.f14263a)) {
            this.f14128a0.mo18753c();
            vVar = C13145v.f29587a;
        } else if (C12880j.m40224a((Object) dVar, (Object) C6230k.f14267a)) {
            this.f14128a0.mo18757g();
            vVar = C13145v.f29587a;
        } else if (C12880j.m40224a((Object) dVar, (Object) C6233n.f14270a)) {
            m19578B();
            vVar = C13145v.f29587a;
        } else if (C12880j.m40224a((Object) dVar, (Object) C6229j.f14266a)) {
            this.f14128a0.mo18756f();
            vVar = C13145v.f29587a;
        } else if (dVar instanceof C6232m) {
            m19587a(((C6232m) dVar).mo18823a());
            vVar = C13145v.f29587a;
        } else if (C12880j.m40224a((Object) dVar, (Object) C6221b.f14257a)) {
            m19582F();
            vVar = C13145v.f29587a;
        } else if (C12880j.m40224a((Object) dVar, (Object) C6222c.f14258a)) {
            this.f14128a0.mo18754d();
            vVar = C13145v.f29587a;
        } else if (C12880j.m40224a((Object) dVar, (Object) C6228i.f14265a)) {
