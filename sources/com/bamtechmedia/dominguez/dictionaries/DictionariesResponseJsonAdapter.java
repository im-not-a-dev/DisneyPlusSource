...
public final class DictionariesResponseJsonAdapter extends C11725h<DictionariesResponse> {
    ...
    public DictionariesResponseJsonAdapter(C11760v vVar) {
        ...
        Intrinsics.checkReturnedValueIsNotNull((Object) a, "JsonReader.Options.of(\"Dictionaries\")");
        this.options = a;
        ...
        Intrinsics.checkReturnedValueIsNotNull((Object) a2, "moshi.adapter<List<Dicti…ptySet(), \"dictionaries\")");
