...
public final class LegalCenterItemsFactory {
    ...
    private final List<C11847b> createDocumentItems(State state, LegalDocument legalDocument) {
        LegalDocumentTitleItem legalDocumentTitleItem = new LegalDocumentTitleItem(legalDocument, Intrinsics.areEqual((Object) state.getOpenDocument(), (Object) legalDocument), this.viewModel);
        CharSequence charSequence = (CharSequence) state.getSpannedDocumentContent().get(legalDocument.getDocumentCode());
        if (C5837i.m18843e(this.context) || (!Intrinsics.areEqual((Object) state.getOpenDocument(), (Object) legalDocument))) {
