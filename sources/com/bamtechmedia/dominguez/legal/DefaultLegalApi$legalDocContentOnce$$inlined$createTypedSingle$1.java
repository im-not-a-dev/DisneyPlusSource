...
public final class DefaultLegalApi$legalDocContentOnce$$inlined$createTypedSingle$1<T, R> implements Function<T, R> {
    final /* synthetic */ C11725h $adapter;

    public DefaultLegalApi$legalDocContentOnce$$inlined$createTypedSingle$1(C11725h hVar) {
        this.$adapter = hVar;
    }
