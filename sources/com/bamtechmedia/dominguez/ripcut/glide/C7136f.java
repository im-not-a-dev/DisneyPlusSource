...
public final class C7136f implements C7159g {
    ...
    static final class C7137a<V> implements Callable<CompletableSource> {
        ...
        public final Completable call() {
            ...
            Intrinsics.checkReturnedValueIsNotNull((Object) e, "Glide.with(context)");
            ...
            Intrinsics.checkReturnedValueIsNotNull((Object) a2, "requestManager.load(uri)…FER_RGB_565 else DEFAULT)");
            C10665m mVar = (C10665m) a2;
            if (cVar.mo20000h() != null) {
                C10670o h = cVar.mo20000h();
                if (h != null) {
                    Intrinsics.checkReturnedValueIsNotNull((Object) mVar.mo19940a(h), "builder.transition(requi…errideTransitionOptions))");
                } else {
    ...
    public void mo19957a(ImageView imageView, String str, Function1<? super C7162c, C13145v> function1) {
        ...
        if (!(str == null || str.length() == 0)) {
            ...
            Intrinsics.checkReturnedValueIsNotNull((Object) context, "imageView.context");
            C10667n a = C10652e.m33414a((View) imageView);
            Intrinsics.checkReturnedValueIsNotNull((Object) a, "Glide.with(imageView)");
            C7162c cVar = new C7162c();
            function1.invoke(cVar);
            ...
            Intrinsics.checkReturnedValueIsNotNull((Object) a3, "requestManager.load(uri)…FER_RGB_565 else DEFAULT)");
            ...
            Intrinsics.checkReturnedValueIsNotNull((Object) mVar.mo27564a(imageView), "createRequest(\n         …        ).into(imageView)");
            return;
        }
        C7162c cVar2 = new C7162c();
        function1.invoke(cVar2);
        Integer d = cVar2.mo19993d();
        if (Intrinsics.areEqual((Object) d, (Object) Integer.valueOf(0))) {
            d = null;
        }
        if (d != null) {
    ...
    public Drawable mo19956a(String str, Function1<? super C7162c, C13145v> function1) {
        ...
        Intrinsics.checkReturnedValueIsNotNull(obj, "createRequest(context, G…tersBlock).submit().get()");
        return (Drawable) obj;
    }
    ...
    public final C10731h m21651a(C7162c cVar) {
        ...
        if (Intrinsics.areEqual((Object) j, (Object) Integer.valueOf(0))) {
            j = null;
        }
        if (j != null) {
