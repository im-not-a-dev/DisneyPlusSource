...
public final class C5836h0 {
    ...
    public static final void m18832a(SharedPreferences sharedPreferences, String str, Object obj) {
        ...
        if (obj != null ? obj instanceof String : true) {
            ...
            Intrinsics.checkReturnedValueIsNotNull((Object) edit, str2);
            edit.putString(str, (String) obj);
            edit.apply();
        } else if (obj instanceof Integer) {
            Editor edit2 = sharedPreferences.edit();
            Intrinsics.checkReturnedValueIsNotNull((Object) edit2, str2);
            edit2.putInt(str, ((Number) obj).intValue());
            edit2.apply();
        } else if (obj instanceof Boolean) {
            Editor edit3 = sharedPreferences.edit();
            Intrinsics.checkReturnedValueIsNotNull((Object) edit3, str2);
            edit3.putBoolean(str, ((Boolean) obj).booleanValue());
            edit3.apply();
        } else if (obj instanceof Float) {
            Editor edit4 = sharedPreferences.edit();
            Intrinsics.checkReturnedValueIsNotNull((Object) edit4, str2);
            edit4.putFloat(str, ((Number) obj).floatValue());
            edit4.apply();
        } else if (obj instanceof Long) {
            Editor edit5 = sharedPreferences.edit();
            Intrinsics.checkReturnedValueIsNotNull((Object) edit5, str2);
            edit5.putLong(str, ((Number) obj).longValue());
            edit5.apply();
        } else if (obj instanceof DateTime) {
            Editor edit6 = sharedPreferences.edit();
            Intrinsics.checkReturnedValueIsNotNull((Object) edit6, str2);
