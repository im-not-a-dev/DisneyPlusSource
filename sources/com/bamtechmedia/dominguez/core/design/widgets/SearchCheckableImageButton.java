...
public final class SearchCheckableImageButton extends C5659a {
    ...
    public SearchCheckableImageButton(Context context, AttributeSet attributeSet, int i) {
        ...
        if (c != null) {
            Intrinsics.checkReturnedValueIsNotNull((Object) c, "AppCompatResources.getDr…rawable.search_to_back)!!");
            this.f13279W = c;
            Drawable c2 = C3868a.m12946c(context, C3836f.back_to_search);
            if (c2 != null) {
                Intrinsics.checkReturnedValueIsNotNull((Object) c2, "AppCompatResources.getDr…rawable.back_to_search)!!");
                this.f13280a0 = c2;
