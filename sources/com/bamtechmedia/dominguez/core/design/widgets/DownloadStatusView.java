...
public final class DownloadStatusView extends AppCompatImageView {
    ...
    private final void setupAttributes(AttributeSet attributeSet) {
        ...
        C12880j.m40222a((Object) iArr, "R.styleable.DownloadStatusView");
    ...
    public void setImageLevel(int i) {
        ...
        String str = "drawable";
        C12880j.m40222a((Object) drawable, str);
        int level = drawable.getLevel();
        super.setImageLevel(i);
        if (i == 3 && level != i) {
            Drawable drawable2 = getDrawable();
            C12880j.m40222a((Object) drawable2, str);
            ...
            if (animatable != null && !animatable.isRunning()) {
                ...
                C12880j.m40222a((Object) drawable3, str);
