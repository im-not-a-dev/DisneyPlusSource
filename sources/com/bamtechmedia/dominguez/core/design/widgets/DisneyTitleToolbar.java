...
public final class DisneyTitleToolbar extends ConstraintLayout {
        ...
        public boolean equals(Object obj) {
            if (this != obj) {
                if (obj instanceof C5620b) {
                    ...
                    if (Intrinsics.areEqual((Object) this.f13203a, (Object) bVar.f13203a)) {
                        if (!(this.f13204b == bVar.f13204b) || !Intrinsics.areEqual((Object) this.f13205c, (Object) bVar.f13205c)) {
                            return false;
                        }
                    }
                }
    ...
    private final void setToolbarBackButton(C5621c cVar) {
        ...
        Intrinsics.checkReturnedValueIsNotNull((Object) c, "closeButtonLayout");
        boolean z = true;
        int i = 0;
        c.setVisibility(cVar != C5621c.CLOSE_BUTTON ? 4 : 0);
        View c2 = mo2145c(C3838h.backButtonLayout);
        Intrinsics.checkReturnedValueIsNotNull((Object) c2, "backButtonLayout");
        c2.setVisibility(cVar != C5621c.BACK_BUTTON ? 4 : 0);
        View c3 = mo2145c(C3838h.blackBackButtonLayout);
        Intrinsics.checkReturnedValueIsNotNull((Object) c3, "blackBackButtonLayout");
    ...
    public final void mo17380c(boolean z) {
        ...
        Intrinsics.checkReturnedValueIsNotNull((Object) c, "spacingNoButton");
        int i = 0;
        ...
        if (z) {
            ...
            Intrinsics.checkReturnedValueIsNotNull((Object) c3, str2);
            c3.setVisibility(this.f13198r0 != C5621c.BACK_BUTTON ? 4 : 0);
            View c4 = mo2145c(C3838h.blackBackButtonLayout);
            Intrinsics.checkReturnedValueIsNotNull((Object) c4, str);
        ...
        Intrinsics.checkReturnedValueIsNotNull((Object) c5, str3);
        c5.setVisibility(8);
        View c6 = mo2145c(C3838h.backButtonLayout);
        Intrinsics.checkReturnedValueIsNotNull((Object) c6, str2);
        c6.setVisibility(8);
        View c7 = mo2145c(C3838h.blackBackButtonLayout);
        Intrinsics.checkReturnedValueIsNotNull((Object) c7, str);
        c7.setVisibility(8);
    }

    public final void setActionTitle(String str) {
        TextView textView = (TextView) mo2145c(C3838h.actionButton);
        Intrinsics.checkReturnedValueIsNotNull((Object) textView, "actionButton");
    ...
    public DisneyTitleToolbar(Context context, AttributeSet attributeSet, int i) {
        ...
        Intrinsics.checkReturnedValueIsNotNull((Object) iArr, "R.styleable.DisneyTitleToolbar");
        ...
        Intrinsics.checkReturnedValueIsNotNull((Object) textView2, "actionButton");
        ...
        Intrinsics.checkReturnedValueIsNotNull((Object) c, "toolbarBackground");
        float f = 0.0f;
        c.setAlpha(0.0f);
        View c2 = mo2145c(C3838h.separator);
        Intrinsics.checkReturnedValueIsNotNull((Object) c2, "separator");
        c2.setAlpha(0.0f);
    ...
    public final void mo17379b(boolean z) {
        ...
        Intrinsics.checkReturnedValueIsNotNull((Object) findViewById, "findViewById<View>(toolbarBackButton.buttonId)");
    ...
    public final void setTitle(C5620b bVar) {
        ...
        String str = "title";
        Intrinsics.checkReturnedValueIsNotNull((Object) textView, str);
        if (!Intrinsics.areEqual((Object) textView.getText(), (Object) bVar.mo17386c())) {
            TextView textView2 = (TextView) mo2145c(C3838h.title);
    ...
    public final void mo17374a(RecyclerView recyclerView, C3848a aVar, Function1<? super Integer, C5620b> function1, Integer num, Function1<? super Integer, C13145v> function12, int i, Function0<C13145v> function0) {
        ...
        Intrinsics.checkReturnedValueIsNotNull((Object) linearLayout, "contentToolbarLayout");
    ...
    public final void mo17376a(CharSequence charSequence, CharSequence charSequence2) {
        ...
        Intrinsics.checkReturnedValueIsNotNull((Object) c, "backButtonLayout");
        c.setContentDescription(charSequence);
        View c2 = mo2145c(C3838h.blackBackButtonLayout);
        Intrinsics.checkReturnedValueIsNotNull((Object) c2, "blackBackButtonLayout");
        c2.setContentDescription(charSequence);
        View c3 = mo2145c(C3838h.closeButtonLayout);
        Intrinsics.checkReturnedValueIsNotNull((Object) c3, "closeButtonLayout");
