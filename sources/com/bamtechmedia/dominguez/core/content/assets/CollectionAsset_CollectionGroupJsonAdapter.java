...
public final class CollectionAsset_CollectionGroupJsonAdapter extends C11725h<CollectionGroup> {
    ...
    public CollectionAsset_CollectionGroupJsonAdapter(C11760v vVar) {
        ...
        Intrinsics.checkReturnedValueIsNotNull((Object) a, "JsonReader.Options.of(\"k… \"contentClass\", \"slugs\")");
        this.options = a;
        C11725h<String> a2 = vVar.mo29869a((Type) String.class, C13188p0.m40531a(), str3);
        Intrinsics.checkReturnedValueIsNotNull((Object) a2, "moshi.adapter<String>(St…ctions.emptySet(), \"key\")");
        this.stringAdapter = a2;
        C11725h<String> a3 = vVar.mo29869a((Type) String.class, C13188p0.m40531a(), str2);
        Intrinsics.checkReturnedValueIsNotNull((Object) a3, "moshi.adapter<String?>(S…ptySet(), \"contentClass\")");
        ...
        Intrinsics.checkReturnedValueIsNotNull((Object) a4, "moshi.adapter<List<Colle…ions.emptySet(), \"slugs\")");
