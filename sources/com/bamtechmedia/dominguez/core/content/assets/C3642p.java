...
public final class C3642p {
    ...
    public static final List<String> m12399b(List<Participant> list, int i) {
        if (list != null) {
            ...
            for (Object next : list) {
                if (C12880j.m40224a((Object) C5838i0.m18844a(((Participant) next).mo13152Z()), (Object) C5838i0.m18844a("Actor"))) {
                    arrayList.add(next);
                }
            }
    ...
    public static final String m12396a(List<Participant> list) {
        ...
        ArrayList arrayList = new ArrayList();
        for (Object next : list) {
            if (C12880j.m40224a((Object) ((Participant) next).mo13152Z(), (Object) "Director")) {
                arrayList.add(next);
            }
        }
    ...
    public static final List<String> m12397a(List<Participant> list, int i) {
        if (list != null) {
            ArrayList arrayList = new ArrayList();
            for (Object next : list) {
                if (C12880j.m40224a((Object) C5838i0.m18844a(((Participant) next).mo13152Z()), (Object) C5838i0.m18844a("Creator"))) {
                    arrayList.add(next);
                }
            }
