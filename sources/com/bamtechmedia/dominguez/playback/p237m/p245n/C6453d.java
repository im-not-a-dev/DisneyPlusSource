...
public final class C6453d {
    ...
    private final C6447a m20140b(Throwable th) {
        Timber.m44528b(th, "drm exception during playback", new Object[0]);
    ...
    private final C6447a m20139a(ServiceException serviceException) {
        Timber.m44528b(serviceException, "service exception during playback", new Object[0]);
        ...
        if (Intrinsics.areEqual((Object) b.mo20545c(), (Object) UnexpectedError.INSTANCE)) {
            b = null;
        }
