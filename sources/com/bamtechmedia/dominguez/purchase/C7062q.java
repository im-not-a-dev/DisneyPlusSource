...
public final class C7062q implements C7885o {
    ...
    static final class C7066d<T> implements Consumer<Paywall> {
        ...
        public final void accept(Paywall paywall) {
            ...
            Intrinsics.checkReturnedValueIsNotNull((Object) paywall, "paywall");
    ...
    private final Single<C7887p> m21427c() {
        ...
        Intrinsics.checkReturnedValueIsNotNull((Object) d, "paywallServicesInteracto…          .firstOrError()");
        return d;
    }
    ...
    public Single<C7820a> mo19841a(boolean z) {
        ...
        if (paywall == null || list == null || z) {
            ...
            Intrinsics.checkReturnedValueIsNotNull((Object) g, "monitorServiceEvents()\n …pl(it, cachedPaywall!!) }");
            Single<C7820a> h = g.mo30218b((Consumer<? super Throwable>) C7077o.f15689c).mo30235h(new C7078p(this));
            Intrinsics.checkReturnedValueIsNotNull((Object) h, "monitorServiceEvents()\n …         })\n            }");
            return h;
        }
        Single<C7820a> b = Single.m38399b(new C7821b(list, paywall));
        Intrinsics.checkReturnedValueIsNotNull((Object) b, "Single.just(DmgzPaywallImpl(products, paywall))");
        return b;
    }
    ...
    private final Single<Paywall> m21428c(boolean z) {
        ...
        Intrinsics.checkReturnedValueIsNotNull((Object) a, "paywallApi.getPaywall()\n…veOn(mainThreadScheduler)");
        return a;
    }
    ...
    public Completable mo19840a() {
        ...
        Intrinsics.checkReturnedValueIsNotNull((Object) b, "fetchPaywall(false)\n    …ble.never()\n            }");
        return b;
    }
    ...
    public final Single<C7887p> m21416a(C7887p pVar) {
        ...
        if (m21429d(pVar) || b) {
            ...
            Intrinsics.checkReturnedValueIsNotNull((Object) g, "fetchPaywall()\n         …      }\n                }");
            return g;
        }
        Single<C7887p> b2 = Single.m38399b(pVar);
        Intrinsics.checkReturnedValueIsNotNull((Object) b2, "Single.just(event)");
        return b2;
    }
