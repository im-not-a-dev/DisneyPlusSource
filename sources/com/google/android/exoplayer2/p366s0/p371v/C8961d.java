...
final class C8961d {
    ...
    /* renamed from: a */
    private static final int f19504a = Util.m29428b("vide");

    /* renamed from: b */
    private static final int f19505b = Util.m29428b("soun");

    /* renamed from: c */
    private static final int f19506c = Util.m29428b("text");

    /* renamed from: d */
    private static final int f19507d = Util.m29428b("sbtl");

    /* renamed from: e */
    private static final int f19508e = Util.m29428b("subt");

    /* renamed from: f */
    private static final int f19509f = Util.m29428b("clcp");

    /* renamed from: g */
    private static final int f19510g = Util.m29428b("meta");

    /* renamed from: h */
    private static final int f19511h = Util.m29428b("mdta");

    /* renamed from: i */
    private static final byte[] f19512i = Util.m29447d("OpusHead");
    ...
    public static Metadata m26378b(C8959a aVar) {
        ...
        while (wVar2.mo24679a() > 8) {
            ...
            if (i5 < 0 || i5 >= strArr.length) {
                ...
                sb.append(i5);
                Log.m29500d("AtomParsers", sb.toString());
            } else {
    ...
    private static boolean m26375a(long[] jArr, long j, long j2, long j3) {
        ...
        int a = Util.m29382a(4, 0, length);
        int a2 = Util.m29382a(jArr.length - 4, 0, length);
