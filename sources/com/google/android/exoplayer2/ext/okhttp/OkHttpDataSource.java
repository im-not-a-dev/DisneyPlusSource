...
public class OkHttpDataSource extends C9497h implements HttpDataSource {

    /* renamed from: s */
    private static final byte[] f19074s = new byte[4096];

    /* renamed from: e */
    private final Factory f19075e;

    /* renamed from: f */
    private final Factory f19076f = new Factory();
    ...
    public OkHttpDataSource(Factory aVar, String str, C9574y<String> yVar, CacheControl cacheControl, Factory eVar) {
        super(true);
