...
public final class Loader implements LoaderErrorThrower {
    ...
    /* renamed from: b */
    public LoadTask<? extends Loadable> f21957b;
    /* access modifiers changed from: private */
    ...
    /* compiled from: Loader */
    public interface C9444b<T extends Loadable> {
        /* renamed from: a */
    ...
    private final class LoadTask<T extends Loadable> extends Handler implements Runnable {
        ...
        public LoadTask(Looper looper, T t, C9444b<T> bVar, int i, long j) {
            super(looper);
            this.f21961U = t;
            this.f21963W = bVar;
            this.f21969c = i;
                ...
                if (i == 0) {
                    ...
                    if (i2 == 1) {
                        ...
                        try {
                            ...
                            Loader.this.f21958c = new C9450h(e);
                        }
                    } else if (i2 == 3) {
                        ...
                        if (a.f21959a == 3) {
                            Loader.this.f21958c = this.f21964X;
                        } else if (a.f21959a != 2) {
                            if (a.f21959a == 1) {
                                this.f21965Y = 1;
                            }
        ...
        public void mo24465a(long j) {
            Assertions.checkState(Loader.this.f21957b == null);
            Loader.this.f21957b = this;
            if (j > 0) {
        ...
        private void m28975a() {
            this.f21964X = null;
            Loader.this.f21956a.execute(Loader.this.f21957b);
        }
    }
    ...
    /* renamed from: a */
    public <T extends Loadable> long mo24455a(T t, C9444b<T> bVar, int i) {
        Looper myLooper = Looper.myLooper();
        Assertions.checkState(myLooper != null);
        this.f21958c = null;
        long elapsedRealtime = SystemClock.elapsedRealtime();
        LoadTask dVar = new LoadTask(myLooper, t, bVar, i, elapsedRealtime);
        dVar.mo24465a(0);
    ...
    public void mo24457a(C9448f fVar) {
        LoadTask<? extends Loadable> dVar = this.f21957b;
        if (dVar != null) {
            dVar.mo24466a(true);
        }
        if (fVar != null) {
