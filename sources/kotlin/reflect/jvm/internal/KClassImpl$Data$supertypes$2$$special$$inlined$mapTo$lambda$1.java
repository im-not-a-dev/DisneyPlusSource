    ...
    public final Type invoke() {
        ...
        if (declarationDescriptor instanceof ClassDescriptor) {
            ...
            if (javaClass == null) {
                ...
                Intrinsics.checkReturnedValueIsNotNull((Object) genericSuperclass, "jClass.genericSuperclass");
                return genericSuperclass;
            } else {
                Class[] interfaces = KClassImpl.this.getJClass().getInterfaces();
                Intrinsics.checkReturnedValueIsNotNull((Object) interfaces, "jClass.interfaces");
                int c = C13174k.m40396c((Object[]) interfaces, (Object) javaClass);
                if (c >= 0) {
                    Type type = KClassImpl.this.getJClass().getGenericInterfaces()[c];
                    Intrinsics.checkReturnedValueIsNotNull((Object) type, "jClass.genericInterfaces[index]");
                    return type;
                }
