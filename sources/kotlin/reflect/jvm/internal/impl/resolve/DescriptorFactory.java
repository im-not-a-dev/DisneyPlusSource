...
public class DescriptorFactory {
    ...
    private static /* synthetic */ void $$$reportNull$$$0(int i) {
        ...
        String str3 = "createEnumValueOfMethod";
        String str4 = "createEnumValuesMethod";
        String str5 = "createSetter";
        if (i == 12) {
            objArr[1] = str5;
        } else if (i == 23) {
            objArr[1] = str4;
    ...
    public static SimpleFunctionDescriptor createEnumValueOfMethod(ClassDescriptor classDescriptor) {
        ...
        SimpleFunctionDescriptorImpl create = SimpleFunctionDescriptorImpl.create(classDescriptor2, Annotations.Companion.getEMPTY(), DescriptorUtils.ENUM_VALUE_OF, Kind.SYNTHESIZED, classDescriptor.getSource());
        ...
        SimpleFunctionDescriptorImpl initialize = create.initialize((ReceiverParameterDescriptor) null, (ReceiverParameterDescriptor) null, Collections.emptyList(), Collections.singletonList(valueParameterDescriptorImpl), (KotlinType) classDescriptor.getDefaultType(), Modality.FINAL, Visibilities.PUBLIC);
        if (initialize == null) {
            $$$reportNull$$$0(25);
        }
        return initialize;
