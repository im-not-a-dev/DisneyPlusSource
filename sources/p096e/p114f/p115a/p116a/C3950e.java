...
public class C3950e extends C3945b {

    /* renamed from: a */
    private double[] f9807a;

    /* renamed from: b */
    private double[][] f9808b;

    /* renamed from: c */
    private double[][] f9809c;

    public C3950e(double[] dArr, double[][] dArr2) {
        double[] dArr3 = dArr;
        double[][] dArr4 = dArr2;
    ...
    /* renamed from: a */
    private static double m13307a(double d, double d2, double d3, double d4, double d5, double d6) {
        double d7 = d2 * d2;
        double d8 = d2 * 6.0d;
        double d9 = 3.0d * d;
    ...
    /* renamed from: b */
    private static double m13308b(double d, double d2, double d3, double d4, double d5, double d6) {
        double d7 = d2 * d2;
        double d8 = d7 * d2;
        double d9 = 3.0d * d7;
        double d10 = d * d6;
    ...
    public void mo14185a(double d, double[] dArr) {
        double[] dArr2 = this.f9807a;
        int length = dArr2.length;
        int i = 0;
        int length2 = this.f9808b[0].length;
        if (d <= dArr2[0]) {
            for (int i2 = 0; i2 < length2; i2++) {
                dArr[i2] = this.f9808b[0][i2];
            }
            return;
        }
        int i3 = length - 1;
        ...
        while (i4 < i3) {
            if (d == this.f9807a[i4]) {
                for (int i5 = 0; i5 < length2; i5++) {
                    dArr[i5] = this.f9808b[i4][i5];
                }
            }
            double[] dArr3 = this.f9807a;
            int i6 = i4 + 1;
            if (d < dArr3[i6]) {
                double d2 = dArr3[i6] - dArr3[i4];
                double d3 = (d - dArr3[i4]) / d2;
                while (i < length2) {
                    double[][] dArr4 = this.f9808b;
                    double d4 = dArr4[i4][i];
                    double d5 = dArr4[i6][i];
                    double[][] dArr5 = this.f9809c;
                    dArr[i] = m13308b(d2, d3, d4, d5, dArr5[i4][i], dArr5[i6][i]);
                    i++;
                }
                return;
            }
        ...
        while (i2 < length - 1) {
            ...
            if (d2 <= dArr3[i3]) {
                ...
                for (int i4 = 0; i4 < length2; i4++) {
                    ...
                    double[][] dArr5 = this.f9809c;
                    dArr[i4] = m13307a(d3, d4, d5, d6, dArr5[i2][i4], dArr5[i3][i4]) / d3;
                }
                return;
            }
            i2 = i3;
    ...
    public void mo14186a(double d, float[] fArr) {
        double[] dArr = this.f9807a;
        int length = dArr.length;
        int i = 0;
        int length2 = this.f9808b[0].length;
        if (d <= dArr[0]) {
            for (int i2 = 0; i2 < length2; i2++) {
                fArr[i2] = (float) this.f9808b[0][i2];
            }
            return;
        }
        int i3 = length - 1;
        ...
        while (i4 < i3) {
            if (d == this.f9807a[i4]) {
                for (int i5 = 0; i5 < length2; i5++) {
                    fArr[i5] = (float) this.f9808b[i4][i5];
                }
            }
            double[] dArr2 = this.f9807a;
            int i6 = i4 + 1;
            if (d < dArr2[i6]) {
                ...
                while (i < length2) {
                    double[][] dArr3 = this.f9808b;
                    double d4 = dArr3[i4][i];
                    double d5 = dArr3[i6][i];
                    double[][] dArr4 = this.f9809c;
                    fArr[i] = (float) m13308b(d2, d3, d4, d5, dArr4[i4][i], dArr4[i6][i]);
                    i++;
                }
                return;
            }
    ...
    public double mo14184a(double d, int i) {
        ...
        int i2 = 0;
        if (d <= dArr[0]) {
            return this.f9808b[0][i];
        }
        int i3 = length - 1;
        if (d >= dArr[i3]) {
            return this.f9808b[i3][i];
        }
        while (i2 < i3) {
            double[] dArr2 = this.f9807a;
            if (d == dArr2[i2]) {
                return this.f9808b[i2][i];
            }
            int i4 = i2 + 1;
            if (d < dArr2[i4]) {
                ...
                double[][] dArr4 = this.f9809c;
                return m13308b(d2, d3, d4, d5, dArr4[i2][i], dArr4[i4][i]);
            }
            i2 = i4;
        }
        return 0.0d;
