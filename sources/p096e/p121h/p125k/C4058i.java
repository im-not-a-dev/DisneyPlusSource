...
/* renamed from: e.h.k.i */
/* compiled from: TypefaceCompatUtil */
public class C4058i {
    /* renamed from: a */
    public static File m13957a(Context context) {
    ...
    private static java.nio.ByteBuffer m13960a(java.io.File r7) {
        /*
        ...
        L_0x0025:
            ...
            return r7
        */
        throw new UnsupportedOperationException("Method not decompiled: p096e.p121h.p125k.C4058i.m13960a(java.io.File):java.nio.ByteBuffer");
    }
    ...
    /* renamed from: a */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static java.nio.ByteBuffer m13959a(android.content.Context r7, android.os.CancellationSignal r8, android.net.Uri r9) {
        /*
        ...
        L_0x004f:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: p096e.p121h.p125k.C4058i.m13959a(android.content.Context, android.os.CancellationSignal, android.net.Uri):java.nio.ByteBuffer");
    }

    /* renamed from: a */
    public static ByteBuffer m13958a(Context context, Resources resources, int i) {
        File a = m13957a(context);
        if (a == null) {
            return null;
        }
        try {
            if (!m13962a(a, resources, i)) {
                return null;
            }
            ByteBuffer a2 = m13960a(a);
            a.delete();
            return a2;
        } finally {
            a.delete();
    ...
    /* renamed from: a */
    public static boolean m13963a(File file, InputStream inputStream) {
            ...
            try {
                ...
                while (true) {
                    ...
                    if (read != -1) {
                        ...
                        m13961a((Closeable) fileOutputStream2);
                ...
                try {
                    ...
                    m13961a((Closeable) fileOutputStream);
                    StrictMode.setThreadPolicy(allowThreadDiskWrites);
                    return false;
                } catch (Throwable th) {
                    th = th;
    ...
    /* renamed from: a */
    public static boolean m13962a(File file, Resources resources, int i) {
        InputStream inputStream;
        try {
            inputStream = resources.openRawResource(i);
            try {
                boolean a = m13963a(file, inputStream);
                m13961a((Closeable) inputStream);
                return a;
            } catch (Throwable th) {
                th = th;
                m13961a((Closeable) inputStream);
    ...
    /* renamed from: a */
    public static void m13961a(Closeable closeable) {
        if (closeable != null) {
            try {
                closeable.close();
            } catch (IOException unused) {
