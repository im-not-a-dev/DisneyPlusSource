...
public final class C7226t extends BufferedGraphQlResponseConverter {
    ...
    public <T> GraphQlResponse<T> deserialize(BufferedSource bufferedSource, Type type) {
        try {
            ...
            Intrinsics.checkReturnedValueIsNotNull((Object) a, "moshi.adapter(map)");
            ...
            Timber.m44528b(e, "Failed to parse response with moshi", new Object[0]);
            throw e;
        }
    }
    ...
    public <T> String serialize(T t) {
        ...
        if (t instanceof Map) {
            ...
            Intrinsics.checkReturnedValueIsNotNull((Object) hVar, "moshi.adapter<Any>(Map::class.java)");
        } else {
            hVar = this.f15952a.mo29866a(Object.class);
            Intrinsics.checkReturnedValueIsNotNull((Object) hVar, "moshi.adapter<Any>(Any::class.java)");
        }
        String json = hVar.toJson(t);
        Intrinsics.checkReturnedValueIsNotNull((Object) json, "adapter.toJson(model)");
        return json;
    }
}
