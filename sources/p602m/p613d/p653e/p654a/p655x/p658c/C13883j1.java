...
/* renamed from: m.d.e.a.x.c.j1 */
/* compiled from: SecT163K1Point */
public class C13883j1 extends C13817a {
    public C13883j1(C13806d dVar, C13812e eVar, C13812e eVar2) {
        ...
        if (!eVar7.mo35112g()) {
            ...
            if (!a3.mo35112g()) {
                if (i.mo35112g()) {
                    ...
                    eVar6 = b.mo35115j().mo35100a(b).mo35100a(l).mo35098a();
                    if (eVar6.mo35112g()) {
                        return new C13883j1(f, eVar6, f.mo35083e(), this.f30672e);
                    }
                    ...
                    if (c3.mo35112g()) {
                        return new C13883j1(f, c3, f.mo35083e(), this.f30672e);
                    }
                ...
                C13883j1 j1Var = new C13883j1(f, eVar6, eVar5, new C13812e[]{eVar4}, this.f30672e);
                return j1Var;
            } else if (a2.mo35112g()) {
                return mo35166v();
            } else {
    ...
    public C13816g mo35137b() {
        return new C13883j1(null, mo35141c(), mo35144d());
    }
    ...
    public C13816g mo35145d(C13816g gVar) {
        ...
        C13812e a2 = j4.mo35100a(j3).mo35100a(eVar2.mo35106c(eVar3));
        C13812e b = j.mo35106c(j4).mo35100a(j3).mo35105b(a2, j2, j4);
        ...
        if (j5.mo35112g()) {
            ...
            return new C13883j1(f, b, f.mo35083e(), this.f30672e);
        } else {
            C13812e c2 = b.mo35115j().mo35106c(c);
            C13812e c3 = b.mo35106c(j5).mo35106c(j4);
            C13883j1 j1Var = new C13883j1(f, c2, b.mo35100a(j5).mo35115j().mo35105b(a2, j.mo35098a(), c3), new C13812e[]{c3}, this.f30672e);
            return j1Var;
        }
    }
    ...
    public C13816g mo35160q() {
        ...
        C13883j1 j1Var = new C13883j1(dVar2, eVar, a, new C13812e[]{eVar3}, this.f30672e);
        return j1Var;
    }
    ...
    public C13816g mo35166v() {
        ...
        boolean f2 = eVar5.mo35111f();
        if (f2) {
            eVar = eVar4;
        } else {
            eVar = eVar4.mo35106c(eVar5);
        }
        if (!f2) {
            eVar5 = eVar5.mo35115j();
        }
        C13812e a = eVar4.mo35115j().mo35100a(eVar).mo35100a(eVar5);
        if (a.mo35112g()) {
            return new C13883j1(f, a, f.mo35083e(), this.f30672e);
        }
        C13812e j = a.mo35115j();
        if (f2) {
            eVar2 = a;
        } else {
            eVar2 = a.mo35106c(eVar5);
        }
        C13812e j2 = eVar4.mo35100a(eVar3).mo35115j();
        C13883j1 j1Var = new C13883j1(f, j, j2.mo35100a(a).mo35100a(eVar5).mo35106c(j2).mo35100a(j), new C13812e[]{eVar2}, this.f30672e);
        return j1Var;
    }

    public C13883j1(C13806d dVar, C13812e eVar, C13812e eVar2, boolean z) {
    ...
    C13883j1(C13806d dVar, C13812e eVar, C13812e eVar2, C13812e[] eVarArr, boolean z) {
