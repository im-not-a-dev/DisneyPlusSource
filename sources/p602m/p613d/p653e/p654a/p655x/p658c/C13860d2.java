...
/* renamed from: m.d.e.a.x.c.d2 */
/* compiled from: SecT239K1Point */
public class C13860d2 extends C13817a {
    public C13860d2(C13806d dVar, C13812e eVar, C13812e eVar2) {
        ...
        if (!eVar7.mo35112g()) {
            ...
            if (!a3.mo35112g()) {
                if (i.mo35112g()) {
                    ...
                    if (eVar6.mo35112g()) {
                        return new C13860d2(f, eVar6, f.mo35083e(), this.f30672e);
                    }
                    ...
                    if (c3.mo35112g()) {
                        return new C13860d2(f, c3, f.mo35083e(), this.f30672e);
                    }
                ...
                C13860d2 d2Var = new C13860d2(f, eVar6, eVar5, new C13812e[]{eVar4}, this.f30672e);
                return d2Var;
            } else if (a2.mo35112g()) {
                return mo35166v();
            } else {
    ...
    public C13816g mo35137b() {
        return new C13860d2(null, mo35141c(), mo35144d());
    }
    ...
    public C13816g mo35145d(C13816g gVar) {
        ...
        if (j5.mo35112g()) {
            ...
            return new C13860d2(f, b, f.mo35083e(), this.f30672e);
        } else {
            C13812e c2 = b.mo35115j().mo35106c(c);
            C13812e c3 = b.mo35106c(j5).mo35106c(j4);
            C13860d2 d2Var = new C13860d2(f, c2, b.mo35100a(j5).mo35115j().mo35105b(a2, a3, c3), new C13812e[]{c3}, this.f30672e);
            return d2Var;
        }
    }
    ...
    public C13816g mo35160q() {
        ...
        C13860d2 d2Var = new C13860d2(dVar2, eVar, a, new C13812e[]{eVar3}, this.f30672e);
        return d2Var;
    }
    ...
    public C13816g mo35166v() {
        ...
        if (eVar2.mo35112g()) {
            return new C13860d2(f, eVar2, f.mo35083e(), this.f30672e);
        }
        ...
        C13812e eVar7 = j;
        C13812e eVar8 = a;
        C13860d2 d2Var = new C13860d2(f, eVar7, eVar8, new C13812e[]{eVar3}, this.f30672e);
        return d2Var;
    }

    public C13860d2(C13806d dVar, C13812e eVar, C13812e eVar2, boolean z) {
    ...
    C13860d2(C13806d dVar, C13812e eVar, C13812e eVar2, C13812e[] eVarArr, boolean z) {
