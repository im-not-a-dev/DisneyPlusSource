...
/* renamed from: m.d.e.a.x.c.l1 */
/* compiled from: SecT163R1Point */
public class C13891l1 extends C13817a {
    public C13891l1(C13806d dVar, C13812e eVar, C13812e eVar2) {
        ...
        if (!eVar7.mo35112g()) {
            ...
            if (!a3.mo35112g()) {
                if (i.mo35112g()) {
                    ...
                    if (eVar6.mo35112g()) {
                        return new C13891l1(f, eVar6, f.mo35083e().mo35114i(), this.f30672e);
                    }
                    ...
                    if (c3.mo35112g()) {
                        return new C13891l1(f, c3, f.mo35083e().mo35114i(), this.f30672e);
                    }
                ...
                C13891l1 l1Var = new C13891l1(f, eVar6, eVar5, new C13812e[]{eVar4}, this.f30672e);
                return l1Var;
            } else if (a2.mo35112g()) {
                return mo35166v();
            } else {
    ...
    public C13816g mo35137b() {
        return new C13891l1(null, mo35141c(), mo35144d());
    }
    ...
    public C13816g mo35145d(C13816g gVar) {
        ...
        if (j5.mo35112g()) {
            ...
            return new C13891l1(f, b, f.mo35083e().mo35114i(), this.f30672e);
        } else {
            C13812e c2 = b.mo35115j().mo35106c(c);
            C13812e c3 = b.mo35106c(j5).mo35106c(j4);
            C13891l1 l1Var = new C13891l1(f, c2, b.mo35100a(j5).mo35115j().mo35105b(a2, a3, c3), new C13812e[]{c3}, this.f30672e);
            return l1Var;
        }
    }
    ...
    public C13816g mo35160q() {
        ...
        C13891l1 l1Var = new C13891l1(dVar2, eVar, a, new C13812e[]{eVar3}, this.f30672e);
        return l1Var;
    }
    ...
    public C13816g mo35166v() {
        ...
        if (a.mo35112g()) {
            return new C13891l1(f, a, f.mo35083e().mo35114i(), this.f30672e);
        }
        ...
        C13891l1 l1Var = new C13891l1(f, eVar7, a2, new C13812e[]{eVar3}, this.f30672e);
        return l1Var;
    }

    public C13891l1(C13806d dVar, C13812e eVar, C13812e eVar2, boolean z) {
    ...
    C13891l1(C13806d dVar, C13812e eVar, C13812e eVar2, C13812e[] eVarArr, boolean z) {
