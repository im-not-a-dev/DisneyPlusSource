...
/* renamed from: m.d.e.a.x.c.n */
/* compiled from: SecP160R2Point */
public class C13897n extends C13818b {
    public C13897n(C13806d dVar, C13812e eVar, C13812e eVar2) {
    ...
    public C13816g mo35134a(C13816g gVar) {
        ...
        if (!C13960d.m43867b(a4)) {
            ...
            C13897n nVar = new C13897n(f, mVar7, mVar8, new C13812e[]{mVar9}, this.f30672e);
            return nVar;
    ...
    public C13816g mo35137b() {
        return new C13897n(null, mo35141c(), mo35144d());
    }
    ...
    public C13816g mo35160q() {
        ...
        C13897n nVar = new C13897n(this.f30668a, this.f30669b, this.f30670c.mo35113h(), this.f30671d, this.f30672e);
        return nVar;
    }
    ...
    public C13816g mo35166v() {
        ...
        int[] a2 = C13960d.m43863a();
        int[] a3 = C13960d.m43863a();
        C13889l.m43224d(mVar.f30772g, a3);
        int[] a4 = C13960d.m43863a();
        C13889l.m43224d(a3, a4);
        boolean f2 = mVar3.mo35111f();
        int[] iArr = mVar3.f30772g;
        if (!f2) {
            C13889l.m43224d(iArr, a2);
            iArr = a2;
        }
        C13889l.m43225d(mVar2.f30772g, iArr, a);
        C13889l.m43218a(mVar2.f30772g, iArr, a2);
        C13889l.m43221b(a2, a, a2);
        C13889l.m43215a(C13960d.m43866b(a2, a2, a2), a2);
        C13889l.m43221b(a3, mVar2.f30772g, a3);
        C13889l.m43215a(C13969m.m44025c(5, a3, 2, 0), a3);
        C13889l.m43215a(C13969m.m44000a(5, a4, 3, 0, a), a);
        C13893m mVar4 = new C13893m(a4);
        C13889l.m43224d(a2, mVar4.f30772g);
        int[] iArr2 = mVar4.f30772g;
        C13889l.m43225d(iArr2, a3, iArr2);
        int[] iArr3 = mVar4.f30772g;
        C13889l.m43225d(iArr3, a3, iArr3);
        C13893m mVar5 = new C13893m(a3);
        C13889l.m43225d(a3, mVar4.f30772g, mVar5.f30772g);
        int[] iArr4 = mVar5.f30772g;
        C13889l.m43221b(iArr4, a2, iArr4);
        int[] iArr5 = mVar5.f30772g;
        C13889l.m43225d(iArr5, a, iArr5);
        C13893m mVar6 = new C13893m(a2);
        C13889l.m43226e(mVar.f30772g, mVar6.f30772g);
        if (!f2) {
            int[] iArr6 = mVar6.f30772g;
            C13889l.m43221b(iArr6, mVar3.f30772g, iArr6);
        }
        C13893m mVar7 = mVar4;
        C13893m mVar8 = mVar5;
        C13897n nVar = new C13897n(f, mVar7, mVar8, new C13812e[]{mVar6}, this.f30672e);
        return nVar;
    }

    public C13897n(C13806d dVar, C13812e eVar, C13812e eVar2, boolean z) {
    ...
    C13897n(C13806d dVar, C13812e eVar, C13812e eVar2, C13812e[] eVarArr, boolean z) {
