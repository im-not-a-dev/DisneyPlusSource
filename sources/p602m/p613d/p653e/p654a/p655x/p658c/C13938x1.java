...
/* renamed from: m.d.e.a.x.c.x1 */
/* compiled from: SecT233K1Point */
public class C13938x1 extends C13817a {
    public C13938x1(C13806d dVar, C13812e eVar, C13812e eVar2) {
        ...
        if (!eVar7.mo35112g()) {
            ...
            if (!a3.mo35112g()) {
                if (i.mo35112g()) {
                    ...
                    eVar6 = b.mo35115j().mo35100a(b).mo35100a(l);
                    if (eVar6.mo35112g()) {
                        return new C13938x1(f, eVar6, f.mo35083e(), this.f30672e);
                    }
                    ...
                    if (c3.mo35112g()) {
                        return new C13938x1(f, c3, f.mo35083e(), this.f30672e);
                    }
                ...
                C13938x1 x1Var = new C13938x1(f, eVar6, eVar5, new C13812e[]{eVar4}, this.f30672e);
                return x1Var;
            } else if (a2.mo35112g()) {
                return mo35166v();
            } else {
    ...
    public C13816g mo35137b() {
        return new C13938x1(null, mo35141c(), mo35144d());
    }
    ...
    public C13816g mo35145d(C13816g gVar) {
        ...
        C13812e a2 = j3.mo35100a(eVar2.mo35106c(eVar3));
        C13812e a3 = j.mo35098a();
        C13812e b = a3.mo35106c(j4).mo35100a(j3).mo35105b(a2, j2, j4);
        ...
        if (j5.mo35112g()) {
            ...
            return new C13938x1(f, b, f.mo35083e(), this.f30672e);
        } else {
            C13812e c2 = b.mo35115j().mo35106c(c);
            C13812e c3 = b.mo35106c(j5).mo35106c(j4);
            C13938x1 x1Var = new C13938x1(f, c2, b.mo35100a(j5).mo35115j().mo35105b(a2, a3, c3), new C13812e[]{c3}, this.f30672e);
            return x1Var;
        }
    }
    ...
    public C13816g mo35160q() {
        ...
        C13938x1 x1Var = new C13938x1(dVar2, eVar, a, new C13812e[]{eVar3}, this.f30672e);
        return x1Var;
    }
    ...
    public C13816g mo35166v() {
        ...
        if (f2) {
            eVar2 = eVar5.mo35115j().mo35100a(eVar5);
        } else {
            eVar2 = eVar5.mo35100a(eVar6).mo35106c(eVar5);
        }
        if (eVar2.mo35112g()) {
            return new C13938x1(f, eVar2, f.mo35083e(), this.f30672e);
        }
        C13812e j = eVar2.mo35115j();
        if (f2) {
            eVar3 = eVar2;
        } else {
            eVar3 = eVar2.mo35106c(eVar);
        }
        C13812e j2 = eVar5.mo35100a(eVar4).mo35115j();
        if (!f2) {
            eVar6 = eVar.mo35115j();
        }
        C13812e a = j2.mo35100a(eVar2).mo35100a(eVar).mo35106c(j2).mo35100a(eVar6).mo35100a(j).mo35100a(eVar3);
        C13812e eVar7 = j;
        C13812e eVar8 = a;
        C13938x1 x1Var = new C13938x1(f, eVar7, eVar8, new C13812e[]{eVar3}, this.f30672e);
        return x1Var;
    }

    public C13938x1(C13806d dVar, C13812e eVar, C13812e eVar2, boolean z) {
    ...
    C13938x1(C13806d dVar, C13812e eVar, C13812e eVar2, C13812e[] eVarArr, boolean z) {
