...
/* renamed from: m.d.e.a.x.c.p2 */
/* compiled from: SecT409R1Point */
public class C13908p2 extends C13817a {
    public C13908p2(C13806d dVar, C13812e eVar, C13812e eVar2) {
        ...
        if (!eVar7.mo35112g()) {
            ...
            if (!a3.mo35112g()) {
                if (i.mo35112g()) {
                    ...
                    if (eVar6.mo35112g()) {
                        return new C13908p2(f, eVar6, f.mo35083e().mo35114i(), this.f30672e);
                    }
                    ...
                    if (c3.mo35112g()) {
                        return new C13908p2(f, c3, f.mo35083e().mo35114i(), this.f30672e);
                    }
                ...
                C13908p2 p2Var = new C13908p2(f, eVar6, eVar5, new C13812e[]{eVar4}, this.f30672e);
                return p2Var;
            } else if (a2.mo35112g()) {
                return mo35166v();
            } else {
    ...
    public C13816g mo35137b() {
        return new C13908p2(null, mo35141c(), mo35144d());
    }
    ...
    public C13816g mo35145d(C13816g gVar) {
        ...
        if (j5.mo35112g()) {
            ...
            return new C13908p2(f, b, f.mo35083e().mo35114i(), this.f30672e);
        } else {
            C13812e c2 = b.mo35115j().mo35106c(c);
            C13812e c3 = b.mo35106c(j5).mo35106c(j4);
            C13908p2 p2Var = new C13908p2(f, c2, b.mo35100a(j5).mo35115j().mo35105b(a2, j.mo35098a(), c3), new C13812e[]{c3}, this.f30672e);
            return p2Var;
        }
    }
    ...
    public C13816g mo35160q() {
        ...
        C13908p2 p2Var = new C13908p2(dVar2, eVar, a, new C13812e[]{eVar3}, this.f30672e);
        return p2Var;
    }
    ...
    public C13816g mo35166v() {
        ...
        C13812e a = eVar5.mo35115j().mo35100a(eVar).mo35100a(eVar2);
        if (a.mo35112g()) {
            return new C13908p2(f, a, f.mo35083e().mo35114i(), this.f30672e);
        }
        ...
        C13908p2 p2Var = new C13908p2(f, eVar7, a2, new C13812e[]{eVar3}, this.f30672e);
        return p2Var;
    }

    public C13908p2(C13806d dVar, C13812e eVar, C13812e eVar2, boolean z) {
    ...
    C13908p2(C13806d dVar, C13812e eVar, C13812e eVar2, C13812e[] eVarArr, boolean z) {
