...
/* renamed from: m.d.f.c.b.b.c */
/* compiled from: NHKeyFactorySpi */
public class C14051c extends KeyFactorySpi implements C13783b {
    /* renamed from: a */
    public PrivateKey mo35014a(C13521a aVar) throws IOException {
        return new C14049a(aVar);
    }
    ...
    public final KeySpec engineGetKeySpec(Key key, Class cls) throws InvalidKeySpecException {
        String str = ".";
        if (key instanceof C14049a) {
            if (PKCS8EncodedKeySpec.class.isAssignableFrom(cls)) {
                return new PKCS8EncodedKeySpec(key.getEncoded());
            }
        } else if (!(key instanceof C14050b)) {
            StringBuilder sb = new StringBuilder();
    ...
    public final Key engineTranslateKey(Key key) throws InvalidKeyException {
        if ((key instanceof C14049a) || (key instanceof C14050b)) {
            return key;
        }
