...
/* renamed from: m.d.f.c.b.d.c */
/* compiled from: Sphincs256KeyFactorySpi */
public class C14057c extends KeyFactorySpi implements C13783b {
    /* renamed from: a */
    public PrivateKey mo35014a(C13521a aVar) throws IOException {
        return new C14055a(aVar);
    }
    ...
    public final KeySpec engineGetKeySpec(Key key, Class cls) throws InvalidKeySpecException {
        String str = ".";
        if (key instanceof C14055a) {
            if (PKCS8EncodedKeySpec.class.isAssignableFrom(cls)) {
                return new PKCS8EncodedKeySpec(key.getEncoded());
            }
        } else if (!(key instanceof C14056b)) {
            StringBuilder sb = new StringBuilder();
    ...
    public final Key engineTranslateKey(Key key) throws InvalidKeyException {
        if ((key instanceof C14055a) || (key instanceof C14056b)) {
            return key;
        }
