...
/* renamed from: m.d.f.c.b.f.f */
/* compiled from: XMSSKeyFactorySpi */
public class C14064f extends KeyFactorySpi implements C13783b {
    /* renamed from: a */
    public PrivateKey mo35014a(C13521a aVar) throws IOException {
        return new C14061c(aVar);
    }
    ...
    public final KeySpec engineGetKeySpec(Key key, Class cls) throws InvalidKeySpecException {
        String str = ".";
        if (key instanceof C14061c) {
            if (PKCS8EncodedKeySpec.class.isAssignableFrom(cls)) {
                return new PKCS8EncodedKeySpec(key.getEncoded());
            }
        } else if (!(key instanceof C14062d)) {
            StringBuilder sb = new StringBuilder();
    ...
    public final Key engineTranslateKey(Key key) throws InvalidKeyException {
        if ((key instanceof C14061c) || (key instanceof C14062d)) {
            return key;
        }
